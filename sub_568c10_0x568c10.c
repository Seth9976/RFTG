...
int32_t* __convention("regparm")sub_568c10(int32_t arg1, int32_t arg2, int32_t arg3, int32_t* arg4)
{
    ...
    if (edi_1 s> 0)
        ...
        while (true)
            ...
            if (esi_2 s< ecx_1)
                do
                    int32_t eax_3 = arg1 + (esi_2 << 2)
                    
                    if (arg4(eax_3, eax_3 - 4) != 0)
                        esi_2 -= 1
            ...
            result, edx = sub_568e70(var_8_1, edx, arg4, edi_1)
