...
int32_tsub_5b1fab(int32_t arg1)
{
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_5b2063
    return result
}
