...
int32_tsub_5bc59e(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, int32_t arg3, int32_t arg4)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_24 = edi
    ...
    if (result != edx)
        int16_t x87control
        int16_t x87status_1
        x87control, x87status_1 = __fldcw_memmem16(zx.w(sub_5bc470()))
        int16_t x87status_2
        int16_t temp0_1
    ...
    if (data_3166fe0 != 0)
        ...
        if (edx_4 != esi)
            int32_t eax_18 = sub_5bc4fe(ecx_7, edx_4)
            int32_t var_10_1 = eax_18
            int32_t mxcsr = sub_5b4eb4(eax_18.b)
            int32_t edx_5 = 0
