...
int32_tsub_5f36a0(int32_t arg1, int32_t arg2)
{
    ...
    int32_t var_34 = sx.d(rol.w(*(esi + ecx - 4), 8))
    int32_t var_c = sx.d(rol.w(ecx_1[5], 8))
    int32_t var_14 = sx.d(rol.w(ecx_1[4], 8))
    int32_t var_1c = sx.d(rol.w(ecx_1[3], 8))
    int32_t var_24 = sx.d(rol.w(ecx_1[2], 8))
    int32_t var_2c = sx.d(rol.w(ecx_1[1], 8))
    int16_t* eax_1 = esi + eax - 0x40
    int32_t var_40 = esi
    int32_t var_3c = ebx
    int32_t var_30 = sx.d(rol.w(*ecx_1, 8))
    int32_t var_38
    int32_t var_28
    int32_t var_20
    int32_t var_18
    ...
    if (eax_1 u>= esi)
        do
            ...
            edx.w = rol.w(edx.w, 8)
            esi.w = rol.w(esi.w, 8)
            var_8 = sx.d(rol.w(ecx_1[5], 8))
            var_10 = sx.d(rol.w(ecx_1[4], 8))
            var_18 = sx.d(rol.w(ecx_1[3], 8))
            var_20 = sx.d(rol.w(ecx_1[2], 8))
            var_28 = sx.d(rol.w(ecx_1[1], 8))
            var_38 = sx.d(rol.w(*ecx_1, 8))
