...
void* __convention("regparm")sub_438fa0(int32_t arg1)
{
    // 第一条实际指令: int32_t ecx
    int32_t ecx
    int32_t var_8 = ecx
    ...
    if (*(ecx_1 + 0x2c058) != arg1)
        int32_t edx_3 = *(eax + 0xc)
        int32_t temp0_1 = *(ecx_1 + 0x2c064)
        
        if (temp0_1 s> edx_3)
            eax.b = 0
            return eax
        
        if (temp0_1 s>= edx_3 && *(ecx_1 + 0x2c060) u>= esi)
            eax.b = 0
            return eax
    ...
    *(eax_5 + 0x2c060) = eax_3 + esi
    *(eax_5 + 0x2c064) = adc.d(edx_1, edi_1, eax_3 + esi u< eax_3)
    eax_5.b = 1
    return eax_5
}
