...
int32_t __convention("regparm")sub_431010(int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4)
{
    ...
    if (arg3 == *(eax_2 + 0x74))
        sub_4c5870("Halt", &data_83f3d3, "..\code\RFTGClient.cpp", 0x2356, "DisplayLocation")
    ...
    int32_t* eax_6 = sub_4f5350(data_c0217c, edx_1, data_307c584, &var_60)
