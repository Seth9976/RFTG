...
uint32_tsub_61a5b0(int32_t* arg1)
{
    ...
    while (edx[7] != 0)
        ...
        while (i != 0)
            ...
            uint32_t ecx_5 = zx.d((eax_5 u>> 8).b)
            
            if ((eax & 1) != 0)
                esi_2 = esi_2 * ecx u/ 0xff
                edi_1 = edi_1 * result_1 u/ 0xff
                ecx_5 = ecx_5 * ecx_1 u/ 0xff
                edx = arg1
            
            var_8_1 = &var_8_1[1]
            *var_c_1 = (ecx_5 << 8 | edi_1) << 8 | esi_2
            var_c_1 = &var_c_1[1]
        
        result = edx[3]
        int32_t ecx_11 = edx[8]
        *edx += result
        edx[5] += ecx_11
