...
voidsub_4d9ea0(int32_t* arg1, float arg2, float arg3, float arg4, float arg5)
{
    ...
    float var_14_2 = fconvert.s(x87_r7_7 + fconvert.t(var_14_1) * fconvert.t(arg4))
    float eax_5 = data_27e7fe0
    float var_10_2 = fconvert.s(x87_r6_2 + fconvert.t(var_10_1) * fconvert.t(arg5))
