...
int32_tsub_5e2f10(void* arg1, int32_t arg2)
{
    ...
    while (edx u>= ecx)
        ...
        *(edx + 6) = edi_1
        ...
        if (esi * 2 s>= eax_1)
            uint32_t ebx_9 = zx.d(ecx_1[-1]) + zx.d(edi_1)
            ecx_1 -= 8
            var_1c = zx.d((ebx_9 s>> 1).w)
            var_8 = zx.d(((zx.d(ecx_1[2]) + zx.d(var_8.w)) s>> 1).w)
            var_c = zx.d(((zx.d(ecx_1[1]) + zx.d(var_c.w)) s>> 1).w)
            var_10 = zx.d(((zx.d(*ecx_1) + zx.d(var_10.w)) s>> 1).w)
            edi_1 = var_1c.w
            esi -= eax_1
