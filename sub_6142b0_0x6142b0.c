            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    if ((edi & 2) == 0)
                        ...
                        edx_26 = edx_1 * 0xff u/ 0xff
                        var_14_1 = edx_26
                    
                    if ((edi & 0x30) != 0 && edx_26 u< 0xff)
                        edi_1 = edx_26 * edi_1 u/ 0xff
                        ebx_2 = var_14_1 * ebx_2 u/ 0xff
                        var_c_1 = var_14_1 * var_c_1 u/ 0xff
                        edx_26 = var_14_1
                    
                    if (eax_18 == 0x10)
                        var_8_1 = (0xff - edx_26) * var_8_1 u/ 0xff + ebx_2
                        esi_3 = (0xff - edx_26) * esi_3 u/ 0xff + edi_1
                        ecx_6 = (0xff - edx_26) * ecx_6 u/ 0xff + var_c_1
                    else if (eax_18 == 0x20)
                        esi_3 += edi_1
                        ...
                        esi_3 = esi_3 * edi_1 u/ 0xff
                        ecx_6 = ecx_6 * var_c_1 u/ 0xff
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_6 << 8 | var_8_1) << 8 | esi_3
                    var_18_1 += result_1
                    ecx = arg1
                    result_2 = result
