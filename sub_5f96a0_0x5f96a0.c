...
int32_tsub_5f96a0(int32_t arg1, int32_t arg2)
{
    ...
    if (i u< edi)
        ...
        int32_t eax_7
        int32_t edx_2
        edx_2:eax_7 = sx.q(edi - i + 3)
        
        if ((eax_7 + (edx_2 & 3)) s>> 2 s>= 4)
            do
                long double x87_r5_1 = fconvert.t(*i_1)
                i += 0x10
                i_1 = &i_1[0x10]
                *(i - 0x10) = fconvert.s((x87_r7 + x87_r5_1) * x87_r6_1)
                long double x87_r5_4 = fconvert.t(i_1[-0xc])
                *(i - 0xc) = fconvert.s((x87_r5_1 + x87_r5_4) * x87_r6_1)
                long double x87_r5_7 = fconvert.t(i_1[-8])
                *(i - 8) = fconvert.s((x87_r5_4 + x87_r5_7) * x87_r6_1)
                long double x87_r5_10 = fconvert.t(i_1[-4])
                x87_r7 = x87_r5_10
