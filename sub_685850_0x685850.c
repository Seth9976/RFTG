...
int32_tsub_685850(int128_t* arg1, int32_t* arg2)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_20 = edi
    ...
    if (arg2 != 0)
        ...
        if ((eax_2 s> 0 || (eax_2 s>= 0 && ecx_1 u>= 0))
            ...
            if (_rand_s(&var_c) == 0 && sub_5b84b9(&var_10) == 0 && sub_5b84e6(&var_8) == 0)
                int32_t ecx_5 = arg2[1]
                int32_t edi_2 = *arg2
                int32_t result
                
                if (ecx_5 s< 0 || (ecx_5 s<= 0 && edi_2 u<= 0x3f480))
                    result = sub_6872fb(arg1, arg2)
                    ...
                    *(arg1 + 8) = eax_32
                    ...
                    result = sub_6872fb(arg1, &var_18)
                    
                    if (result != 0)
                        return result
                    
                    if (var_c != result && sub_5b8c5b(arg1) != 0)
                        int32_t eax_11
                        int32_t edx_2
