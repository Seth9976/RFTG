            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    uint32_t esi_3 = zx.d((eax_27 u>> 8).b)
                    uint32_t edi_2 = eax_26 u>> 0x18
                    uint32_t ecx_6 = zx.d((eax_27 u>> 0x10).b)
                    uint32_t var_8_1 = zx.d(eax_27.b)
                    ...
                    if (eax_18 == 0x10)
                        ecx_6 = ebx_2 + (0xff - edi_2) * ecx_6 u/ 0xff
                        esi_3 = (0xff - edi_2) * esi_3 u/ 0xff + var_c_1
                        var_8_1 = (0xff - edi_2) * var_8_1 u/ 0xff + var_10_1
                    else if (eax_18 == 0x20)
                        ecx_6 += ebx_2
                        ...
                        uint32_t eax_41 = var_8_1 + var_10_1
                        var_8_1 = eax_41
                        
                        if (eax_41 u> 0xff)
                            var_8_1 = 0xff
                    else if (eax_18 == 0x40)
                        ecx_6 = ecx_6 * ebx_2 u/ 0xff
                        esi_3 = esi_3 * var_c_1 u/ 0xff
