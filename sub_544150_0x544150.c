...
int32_t*sub_544150(int32_t arg1)
{
    // 第一条实际指令: if (arg1 s>= 0x400)
    if (arg1 s>= 0x400)
        sub_4c5870("registerIndex < MAX_UNIFORMS", &data_83f3d3, "OpenGLGraphics.cpp", 0x35f, 
            "GLDupCheck_glUniform4fv")
    ...
    while (true)
        ...
        data_3079544(arg1, 1, entry_result)
        result = data_307882c
