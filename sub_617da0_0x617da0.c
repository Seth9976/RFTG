...
int32_tsub_617da0(int32_t* arg1)
{
        ...
        do
            ...
            if (i_1 != 0)
                ...
                do
                    ...
                    i -= 1
                    uint32_t edi_1 = zx.d((eax_2 u>> 0x10).b)
                    uint32_t var_c_1 = zx.d((eax_2 u>> 8).b)
                    uint32_t var_10_1 = zx.d(eax_2.b)
                    int32_t eax_4 = *var_1c_1
                    uint32_t esi_2 = eax_2 u>> 0x18
                    uint32_t var_8_1 = zx.d((eax_4 u>> 8).b)
                    ...
                    if (eax == 0x10)
                        ebx = (0xff - esi_2) * ebx u/ 0xff + var_14_1
                        var_8_1 = (0xff - esi_2) * var_8_1 u/ 0xff + var_c_1
                        ecx_13 = (0xff - esi_2) * ecx_13 u/ 0xff + var_10_1
                        edx = arg1
                    else if (eax == 0x20)
                        ebx += edi_1
                        ...
                        uint32_t eax_13 = var_8_1 + var_c_1
                        var_8_1 = eax_13
                        ...
                        ebx = ebx * edi_1 u/ 0xff
                        var_8_1 = var_8_1 * var_c_1 u/ 0xff
                        ecx_13 = ecx_13 * var_10_1 u/ 0xff
                        edx = arg1
                    
                    var_18_1 = &var_18_1[1]
                    *var_1c_1 = (ecx_13 << 8 | var_8_1) << 8 | ebx
                    var_1c_1 = &var_1c_1[1]
                while (i != 0)
