...
int32_tsub_6065a0(int32_t arg1, int32_t* arg2, int32_t arg3, void* arg4, void* arg5)
{
    // 第一条实际指令: int32_t ecx
    int32_t ecx
    int32_t var_8 = ecx
    ...
    do
        ...
        uint32_t edi_5 = zx.d(edi_4)
            ...
            | zx.d(*(arg5 + 0x18))
        *(esi_1 + arg2) = ((((*(arg4 + 0x18) & esi_2) u>> *(arg4 + 0x23) & 0x1f8)
            | (edi_5 & 0x7e0) << 0xe) * 4) | (edi_5 & 0xf81f)
        ecx_1 = &arg2[1]
        i = arg1
        arg1 -= 1
        arg2 = ecx_1
