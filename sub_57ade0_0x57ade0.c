...
int32_tsub_57ade0()
{
    ...
    if (result != 0)
        ...
        if (result != 1)
            ...
            x87_r7_1 = fconvert.t(*(eax_4 + 0x14))
        else
            ...
            if (eax_2 == 0)
                ...
                edx_1 = *(eax_5 + 0x14)
                x87_r7_1 = fconvert.t(*(eax_5 + 0x10))
                int32_t var_3c_1 = edx_1
            else
                int32_t* eax_3
                eax_3, edx_1 = sub_4f4890(esi_1)
                x87_r7_1 = fconvert.t(*(*eax_3 + 0x14))
        ...
        if (data_273bc2c s> 0)
            ...
            do
                ...
                long double x87_r6_1 =
                    fconvert.t(fconvert.s(fconvert.t(var_4c_1) - fconvert.t(*(ebx_3 + esi_3 + 0x14))))
