...
int32_t*sub_614cb0(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                uint32_t var_10_1 = zx.d((eax_7 u>> 8).b)
                uint32_t esi_1 = zx.d(eax_9.b)
                uint32_t ecx_6 = eax_9 u>> 0x18
                uint32_t edi_1 = 0xff
                ...
                if ((ecx & 2) != 0)
                    edi_1 = edx_3 * 0xff u/ 0xff
                
                if ((ecx & 0x30) != 0 && edi_1 u< 0xff)
                    ebx_1 = edi_1 * ebx_1 u/ 0xff
                    var_10_1 = edi_1 * var_10_1 u/ 0xff
                    var_14_1 = edi_1 * var_14_1 u/ 0xff
                
                if (ecx_1 == 0x10)
                    var_8_1 = (0xff - edi_1) * var_8_1 u/ 0xff + ebx_1
                    var_c_1 = (0xff - edi_1) * var_c_1 u/ 0xff + var_10_1
                    ecx_6 = edi_1 + (0xff - edi_1) * ecx_6 u/ 0xff
                    esi_1 = (0xff - edi_1) * esi_1 u/ 0xff + var_14_1
                else if (ecx_1 == 0x20)
                ...
                var_20_1 = eax_30
                eax_30[-1] = ((ecx_6 << 8 | var_8_1) << 8 | var_c_1) << 8 | esi_1
            while (i != 0)
