...
uint32_tsub_61b300(int32_t* arg1)
{
    ...
    while (edx[7] != 0)
        ...
        if (i_1 != 0)
            do
                ...
                i -= 1
                uint32_t edi_1 = zx.d((eax_9 u>> 0x10).b)
                uint32_t esi_2 = eax_9 u>> 0x18
                uint32_t ebx_1 = zx.d((eax_9 u>> 8).b)
                uint32_t ecx_6 = zx.d(eax_9.b)
                
                if ((ecx & 1) != 0)
                    esi_2 = esi_2 * eax u/ 0xff
                ...
                var_8_1 = &var_8_1[1]
                *eax_14 = ((ecx_6 << 8 | esi_2) << 8 | edi_1) << 8 | ebx_1
                var_10_1 = &eax_14[1]
            while (i != 0)
