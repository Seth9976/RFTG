...
voidsub_5e15b0(int16_t arg1 @ x87control, void* arg2)
{
    ...
    if (i_1 != 0)
        ...
        do
            ...
            *(esi - 2) = rol.w(
                (int.d((fconvert.t(((var_c_1 & 0xff0000) | var_c_1 u>> 0x10) u>> 8
                    | ((var_c_1 & 0xff00) | var_c_1 << 0x10) << 8) + float.t(1)) * fconvert.t(32767.0)))
                    .w, 
                8)
        while (i != 1)
        edi = arg2
