...
int32_t*sub_544210(int32_t arg1)
{
    // 第一条实际指令: if (arg1 s>= 0x400)
    if (arg1 s>= 0x400)
        sub_4c5870("registerIndex < MAX_UNIFORMS", &data_83f3d3, "OpenGLGraphics.cpp", 0x36c, 
            "GLDupCheck_glUniform4iv")
