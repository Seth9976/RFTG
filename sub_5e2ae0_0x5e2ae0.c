...
int32_tsub_5e2ae0(void* arg1, int32_t arg2)
{
        ...
        do
            ...
            if (ebx_7 * 2 s>= eax - 0x80)
                ...
                *(ecx_1 - 2) = eax_3.b
                ...
                var_7 = ((sx.d(*(esi_1 + 2)) + sx.d(var_7)) s>> 1).b
                var_8 = ((sx.d(*(esi_1 + 3)) + sx.d(var_8)) s>> 1).b
                var_9 = ((sx.d(*(esi_1 + 4)) + sx.d(var_9)) s>> 1).b
                ecx_1 += 8
                eax_3 = (sx.d(eax_3.b) + sx.d(*(esi_1 - 2))) s>> 1
                var_10 -= eax - 0x80
                var_a = ((sx.d(*(esi_1 + 5)) + sx.d(var_a)) s>> 1).b
                edx = ((sx.d(*(esi_1 - 1)) + sx.d(edx)) s>> 1).b
