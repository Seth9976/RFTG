...
long doublesub_5fe830(void* arg1, int32_t arg2)
{
    ...
    if (i u< ebx)
        ...
        int32_t eax_15
        int32_t edx_22
        edx_22:eax_15 = sx.q(ebx - i + 0xf)
        
        if ((eax_15 + (edx_22 & 0xf)) s>> 4 s>= 4)
            result_12 = result_11
