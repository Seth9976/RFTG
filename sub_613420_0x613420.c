            ...
            *(esi + 0x1c) -= 1
            ...
            if (i_1 != 0)
                do
                    ...
                    uint32_t edi_1 = zx.d((eax_20 u>> 8).b)
                    uint32_t ecx_7 = zx.d((eax_20 u>> 0x10).b)
                    uint32_t ebx_3 = zx.d(eax_20.b)
                    
                    if ((eax & 1) != 0)
                        ecx_7 = ecx_7 * ecx u/ 0xff
                        edi_1 = edi_1 * edx u/ 0xff
                        ebx_3 = ebx_3 * eax_1 u/ 0xff
                        edx_4 = var_8_1
                    
                    edx_4 += result_1
                    *result_2 = (ecx_7 << 8 | edi_1) << 8 | ebx_3
                    result = result_2 + 4
                    var_8_1 = edx_4
                    result_2 = result
                while (i != 0)
