            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_8_1 != 0)
                while (true)
                    ...
                    uint32_t esi_2 = zx.d(eax_13.b)
                    result = eax & 0x70
                    uint32_t ecx_7 = zx.d((eax_13 u>> 0x10).b)
                    uint32_t edi_7 = zx.d((eax_13 u>> 8).b)
                    ...
                    if (result == 0x10)
                        ...
                        esi_2 = esi_2 * edx_8 u/ 0xff
                        edi_7 = edi_7 * edx_7 u/ 0xff
                        int32_t edx_13
                        edx_13:result = mulu.dp.d(0x80808081, ecx_7 * edx_6)
                        ecx_7 = ecx_7 * edx_6 u/ 0xff
                    
                    edx_2 = var_1c_1 + result_1
                    *var_28_1 = (ecx_7 << 8 | edi_7) << 8 | esi_2
                    ecx = arg1
                    esi_1 = &var_28_1[1]
                    var_1c_1 = edx_2
                    var_28_1 = esi_1
