...
int32_tsub_5efe50(void* arg1, int32_t arg2)
{
    // 第一条实际指令: void* edx = arg1
    void* edx = arg1
    int32_t ecx = *(edx + 0x18)
    int32_t esi = *(edx + 0x10)
    int32_t ebx = sx.d(*(esi + ecx - 2))
    int32_t eax = ecx << 2
    void* ecx_1 = esi + ecx - 0xc
    int32_t var_24 = sx.d(*(esi + ecx - 4))
    int32_t var_c = sx.d(*(ecx_1 + 6))
    int32_t var_14 = sx.d(*(ecx_1 + 4))
    int32_t var_1c = sx.d(*(ecx_1 + 2))
    int16_t* eax_1 = esi + eax - 0x30
    int32_t var_2c = ebx
    int32_t var_20 = sx.d(*ecx_1)
    int32_t var_28
    int32_t var_18
    int32_t var_10
    int32_t var_8
    ...
    if (eax_1 u>= esi)
        ...
        do
            var_8 = sx.d(*(ecx_1 + 6))
            var_10 = sx.d(*(ecx_1 + 4))
            int32_t edx_1 = sx.d(*(ecx_1 + 0xa))
            var_18 = sx.d(*(ecx_1 + 2))
            var_28 = sx.d(*ecx_1)
            int32_t esi_1 = sx.d(*(ecx_1 + 8))
