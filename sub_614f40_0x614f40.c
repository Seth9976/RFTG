            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_20_1 != 0)
                ...
                while (true)
                    ...
                    uint32_t var_8_1 = zx.d((eax_28 u>> 0x10).b)
                    uint32_t esi_3 = zx.d(eax_28.b)
                    uint32_t ecx_6 = eax_28 u>> 0x18
                    uint32_t edi_1 = 0xff
                    uint32_t var_c_1 = zx.d((eax_28 u>> 8).b)
                    ...
                    if (eax_18 == 0x10)
                        ...
                        ecx_6 = edi_1 + (0xff - edi_1) * ecx_6 u/ 0xff
                        esi_3 = (0xff - edi_1) * esi_3 u/ 0xff + var_14_1
                    else if (eax_18 == 0x20)
                        uint32_t eax_41 = var_8_1 + ebx_2
                        var_8_1 = eax_41
                        
                        if (eax_41 u> 0xff)
                            var_8_1 = 0xff
                        
                        uint32_t eax_43 = var_c_1 + var_10_1
                        var_c_1 = eax_43
                    ...
                    result = result_2 + 4
                    result_2 = result
                    *(result - 4) = ((ecx_6 << 8 | var_8_1) << 8 | var_c_1) << 8 | esi_3
                    var_1c_1 += result_1
                    ecx = arg1
