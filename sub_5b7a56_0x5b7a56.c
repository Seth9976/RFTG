...
int32_t __convention("regparm")sub_5b7a56(char* arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t* arg5, char arg6, int32_t* arg7)
{
    // 第一条实际指令: void* var_14
    void* var_14
    ...
    if (arg1 != 0 && arg2 u> 0)
        ...
        if (arg2 u> eax_3 + 9)
            ...
            int32_t eax_12 = sub_5b04a4(esi_2, ebx_1, "e+000")
            ...
            if ((data_bed324 & 1) != 0 && *(esi_2 + 2) == 0x30)
                sub_5a6c10(esi_2 + 2, esi_2 + 3, 3)
