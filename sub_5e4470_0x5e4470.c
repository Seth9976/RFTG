...
int32_tsub_5e4470(void* arg1, int32_t arg2)
{
    ...
    while (edx u>= ecx)
        ...
        *edx = rol.w(var_10.w, 8)
        ...
        if (esi * 2 s>= eax_1)
            ...
            ecx_1 -= 8
            ebx_6.w = rol.w(ebx_6.w, 8)
            var_1c = zx.d(((zx.d(ebx_6.w) + zx.d(edi_1)) s>> 1).w)
            var_8 = zx.d(((zx.d(rol.w(ecx_1[2], 8)) + zx.d(var_8.w)) s>> 1).w)
            var_c = zx.d(((zx.d(rol.w(ecx_1[1], 8)) + zx.d(var_c.w)) s>> 1).w)
            var_10 = zx.d(((zx.d(rol.w(*ecx_1, 8)) + zx.d(var_10.w)) s>> 1).w)
            edi_1 = var_1c.w
            esi -= eax_1
