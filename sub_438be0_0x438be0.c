...
void*sub_438be0()
{
    ...
    int32_t edx = *(eax + 0xc)
    int32_t ecx = *(eax + 8)
    void* eax_1 = *(eax + 0x548)
    int32_t temp0 = *(eax_1 + 0x2c034)
    
    if (temp0 s>= edx && (temp0 s> edx || *(eax_1 + 0x2c030) u> ecx))
        eax_1.b = 0
        return eax_1
    ...
    long double x87_r6 = fconvert.t(fconvert.s(st0 * fconvert.t(750.0)))
    x87_r6 - x87_r7_2
    ...
    int32_t eax_4
    int32_t edx_1
    edx_1:eax_4 = sx.q(sub_685f40(x87_r7_3))
    void* eax_6 = *(data_27e7a40 + 0x548)
    *(eax_6 + 0x2c030) = eax_4 + ecx
    *(eax_6 + 0x2c034) = adc.d(edx_1, edx, eax_4 + ecx u< eax_4)
    eax_6.b = 1
    return eax_6
}
