...
int32_t __convention("regparm")sub_5a1530(float* arg1, int32_t arg2, float arg3, float arg4, float arg5, int32_t* arg6, int32_t* arg7)
{
    // 第一条实际指令: int32_t ecx
    int32_t ecx
    int32_t var_8 = ecx
    ...
    *arg1 = fconvert.s(x87_r6_2 * x87_r4 - x87_r3_1)
    ...
    st0, x87control_1 = sub_686950(mxcsr, x87control, 
        fconvert.d(x87_r6 + fconvert.t(fconvert.s(
            x87_r4 * fconvert.t(fconvert.s(x87_r6_2 - fconvert.t(arg3))) - x87_r3_1))))
    *arg6 = sub_685f40(st0)
    int32_t result = sub_685f40(sub_686950(mxcsr, x87control_1, 
        fconvert.d(fconvert.t(fconvert.s(
            fconvert.t(fconvert.s(fconvert.t(arg2) + fconvert.t(arg3))) * fconvert.t(arg4)
            - fconvert.t(arg5))) - fconvert.t(0.5))))
    *arg7 = result
    return result
}
