...
int32_tsub_5bb5e4(int32_t arg1, int32_t arg2, int32_t arg3)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_28 = edi
    ...
    int32_t edx
    int32_t edx_1
    eax_1, ecx_1, edx_1 = sub_5b5e2f(eax, edx, ecx, arg1, 0, 0, FILE_CURRENT)
    int32_t eax_2 = eax_1 & edx_1
    
    if (eax_2 != 0xffffffff)
        uint32_t eax_3
        int32_t edx_2
        eax_3, edx_2 = sub_5b5e2f(eax_2, edx_1, ecx_1, arg1, 0, 0, FILE_END)
        ...
        if (ecx_3 != 0xffffffff)
            ...
            if (not(s_1) && ((sbb.d(arg3, edx_2, c_1) != 0 && s_1 == o_1) || esi_2 u> 0))
                ...
                if (lpMem != 0)
                    int32_t eax_8 = sub_5bb009(arg1, 0x8000)
                    ...
                    while (true)
                        ...
                        void* eax_10 = sub_5afcd3(esi_2, arg1, lpMem, eax_9)
            ...
            label_5bb780:
                uint32_t eax_26
                int32_t edx_5
                eax_26, edx_5 = sub_5b5e2f(eax_3, edx_2, ecx_3, arg1, eax_1, edx_1, FILE_BEGIN)
                ...
                uint32_t eax_15
                int32_t edx_4
                eax_15, edx_4 = sub_5b5e2f(eax_3, edx_2, ecx_3, arg1, arg2, arg3, FILE_BEGIN)
                
                if ((eax_15 & edx_4) != 0xffffffff)
                    BOOL eax_18
                    eax_18, ecx_3 = SetEndOfFile(sub_5afa0b(arg1))
