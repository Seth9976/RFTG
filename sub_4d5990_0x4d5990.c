...
int32_t __fastcallsub_4d5990(int32_t* arg1, int32_t arg2 @ esi)
{
    ...
    if (arg2 != 0)
        ...
        if (eax_3 u< arg1[1])
            ...
            if (*(eax_3 * 0x6c + edx_1 + 0x68) == arg2)
                return eax_3 * 0x6c + edx_1
        
        char const* const var_4_1 = "DataArray<struct Structure>::DataArrayGet"
        var_8 = 0x46
        char const* const var_c_1 = "c:\ax2010\engine\DataArray.h"
        char* const var_10_1 = &data_83f3d3
        var_14 = "DataArrayTryToGet(id) != NULL"
    else
        char const* const var_4 = "DataArray<struct Structure>::DataArrayGet"
        var_8 = 0x45
