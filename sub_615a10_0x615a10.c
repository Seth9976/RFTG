            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    if (eax_18 == 0x10)
                        ecx_5 = edi_1 + (0xff - edx_26) * ecx_5 u/ 0xff
                        esi_3 = (0xff - edx_26) * esi_3 u/ 0xff + ebx_2
                        var_8_1 = (0xff - edx_26) * var_8_1 u/ 0xff + var_c_1
                    else if (eax_18 == 0x20)
                        ecx_5 += edi_1
                        ...
                        ecx_5 = ecx_5 * edi_1 u/ 0xff
                        esi_3 = esi_3 * ebx_2 u/ 0xff
                        var_8_1 = var_8_1 * var_c_1 u/ 0xff
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_5 << 8 | esi_3) << 8 | var_8_1
                    var_18_1 += result_1
                    ecx = arg1
                    result_2 = result
