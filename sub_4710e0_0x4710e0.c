...
int32_t __convention("regparm")sub_4710e0(int32_t arg1, int32_t arg2, int32_t* arg3, int32_t* arg4 @ edi, int32_t arg5, int32_t arg6)
{
    // 第一条实际指令: void var_40
    void var_40
    ...
    *(eax_2 + 0x1a08) = *arg3
    ...
    int32_t edx_1 = *arg4
    *(eax_2 + 0x1f30) = edx_1
    sub_46aca0(eax_2 + 0x1a10, edx_1, arg6, *arg4)
