...
int32_t __convention("regparm")sub_4f34a0(int32_t* arg1, int32_t arg2, void** arg3)
{
    // 第一条实际指令: void* ecx = arg3[0xc0]
    void* ecx = arg3[0xc0]
    ...
    void* ecx_2 = arg3[0xbf]
    
    if (ecx_2 == 0)
        arg1[1] = arg3[0xc0]
    else
        *(ecx_2 + 0x300) = arg3[0xc0]
    
    int32_t result = arg3[0xbf]
    arg1[2] -= 1
    sub_4eb760(arg3)
