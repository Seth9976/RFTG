            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    uint32_t edi_1 = zx.d((eax_26 u>> 0x10).b)
                    int32_t eax_28 = *result_2
                    uint32_t var_c_1 = zx.d(eax_26.b)
                    uint32_t ebx_2 = zx.d((eax_26 u>> 8).b)
                    uint32_t esi_3 = zx.d((eax_28 u>> 8).b)
                    uint32_t var_14_1 = 0xff
                    uint32_t ecx_6 = zx.d((eax_28 u>> 0x10).b)
                    uint32_t var_8_1 = zx.d(eax_28.b)
                    
                    if ((edi & 1) != 0)
                        edi_1 = edi_1 * eax u/ 0xff
                        ebx_2 = ebx_2 * edx u/ 0xff
                        var_c_1 = var_c_1 * eax_1 u/ 0xff
                    ...
                    if ((edi & 2) == 0)
                        ...
                        edx_25 = edx_1 * 0xff u/ 0xff
                        var_14_1 = edx_25
                    
                    if ((edi & 0x30) != 0 && edx_25 u< 0xff)
                        edi_1 = edx_25 * edi_1 u/ 0xff
                        ebx_2 = var_14_1 * ebx_2 u/ 0xff
                        var_c_1 = var_14_1 * var_c_1 u/ 0xff
                        edx_25 = var_14_1
                    
                    if (eax_18 == 0x10)
                        ecx_6 = edi_1 + (0xff - edx_25) * ecx_6 u/ 0xff
                        esi_3 = (0xff - edx_25) * esi_3 u/ 0xff + ebx_2
                        var_8_1 = (0xff - edx_25) * var_8_1 u/ 0xff + var_c_1
                    else if (eax_18 == 0x20)
                        ecx_6 += edi_1
                        ...
                        uint32_t eax_42 = var_8_1 + var_c_1
                        var_8_1 = eax_42
                        
                        if (eax_42 u> 0xff)
                            var_8_1 = 0xff
                    else if (eax_18 == 0x40)
                        ecx_6 = ecx_6 * edi_1 u/ 0xff
                        esi_3 = esi_3 * ebx_2 u/ 0xff
                        var_8_1 = var_8_1 * var_c_1 u/ 0xff
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_6 << 8 | esi_3) << 8 | var_8_1
                    var_18_1 += result_1
                    ecx = arg1
                    result_2 = result
