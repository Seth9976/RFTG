...
int32_t*sub_620100(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                i -= 1
                uint32_t var_14_1 = zx.d((eax_7 u>> 0x10).b)
                ...
                if ((ecx & 1) != 0)
                    ...
                    var_14_1 = var_14_1 * edx_1 u/ 0xff
                    edi_2 = edi_2 * edx_2 u/ 0xff
                ...
                if (ecx_1 == 0x10)
                    var_8_1 = (0xff - ebx_1) * var_8_1 u/ 0xff + var_10_1
                    var_c_1 = (0xff - ebx_1) * var_c_1 u/ 0xff + var_14_1
                    ecx_7 = ebx_1 + (0xff - ebx_1) * ecx_7 u/ 0xff
                    esi_1 = (0xff - ebx_1) * esi_1 u/ 0xff + edi_2
                else if (ecx_1 == 0x20)
                    uint32_t eax_22 = var_8_1 + var_10_1
                    var_8_1 = eax_22
                    
                    if (eax_22 u> 0xff)
                        var_8_1 = 0xff
                    
                    uint32_t eax_24 = var_c_1 + var_14_1
                    var_c_1 = eax_24
