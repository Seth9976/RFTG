...
long doublesub_5fa020(int32_t arg1, int32_t arg2)
{
    ...
    if (i u< edi)
        ...
        int32_t eax_7
        int32_t edx_1
        edx_1:eax_7 = sx.q(edi - i + 0xf)
        
        if ((eax_7 + (edx_1 & 0xf)) s>> 4 s>= 4)
            result_12 = result_11
            ...
            do
                ...
                *i = fconvert.s((result + x87_r4) * result_10)
                ...
                long double x87_r4_2 = fconvert.t(i_1[8])
                long double x87_r3_4 = fconvert.t(i_1[9])
                long double x87_r2_10 = fconvert.t(i_1[0xa])
                long double x87_r1_5 = fconvert.t(i_1[0xb])
                ...
                long double x87_r4_4 = fconvert.t(i_1[0x10])
                long double x87_r3_6 = fconvert.t(i_1[0x11])
                long double x87_r2_19 = fconvert.t(i_1[0x12])
                long double x87_r1_9 = fconvert.t(i_1[0x13])
                ...
                result_5 = fconvert.t(i_1[0x18])
                long double result_14 = fconvert.t(i_1[0x19])
                long double result_1 = fconvert.t(i_1[0x1a])
                result_8 = fconvert.t(i_1[0x1b])
                i = &i[0x10]
                i_1 -= 0xffffff80
        ...
        if (i u< edi)
            ...
            while (true)
                ...
                eax_11 += 0x20
                long double result_13 = fconvert.t(*(eax_11 - 0x24))
                edx_3 += 0x10
                int32_t temp1_1 = edi_4
                edi_4 -= 1
                double var_c_4 = fconvert.d(fconvert.t(*(eax_11 - 0x20)))
                double var_14_4 = fconvert.d(fconvert.t(*(eax_11 - 0x1c)))
                *(edx_3 - 0x18) = fconvert.s((result + result_2) * result_11)
                *(edx_3 - 0x14) = fconvert.s((result_12 + result_13) * result_11)
                long double result_9 = fconvert.t(var_c_4)
                long double x87_r5 = result_7 + result_9
                result_7 = result_9
                *(edx_3 - 0x10) = fconvert.s(x87_r5 * result_11)
                *(edx_3 - 0xc) = fconvert.s((result_6 + fconvert.t(var_14_4)) * result_11)
