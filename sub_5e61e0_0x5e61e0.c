...
int32_tsub_5e61e0(void* arg1, int32_t arg2)
{
    ...
    void* esi_1 = ecx + eax_1 - 0x18
    int32_t* ecx_1 = ecx + edi - 0x18
    int32_t edi_1 = ecx_1[5]
    int32_t var_8 = *(ecx + edi - 8)
    int32_t var_c = ecx_1[3]
    int32_t var_10 = ecx_1[2]
    int32_t var_14 = ecx_1[1]
    int32_t edx = 0
    ...
    while (esi_1 u>= ecx)
        ...
        *(esi_1 + 0x14) = edi_1
        ...
        if (edx * 2 s>= eax_1)
            ...
            int32_t eax_9
            int32_t edx_3
            edx_3:eax_9 = sx.q(ecx_1[4])
            var_24 = (eax_3 + eax_5) u>> 1 | adc.d(edx_1, edx_2, eax_3 + eax_5 u< eax_3) << 0x1f
            int32_t eax_11
            int32_t edx_4
            edx_4:eax_11 = sx.q(var_8)
            int32_t eax_13
            int32_t edx_5
            edx_5:eax_13 = sx.q(ecx_1[3])
    ...
    *(arg1 + 0x18) = eax_1
    ...
    return (*(arg1 + (result << 2) + 0x28))(arg1, arg2, var_2c, var_28, var_24, edi - 0x180, ecx, 
