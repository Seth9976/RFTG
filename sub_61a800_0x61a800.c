...
int32_t*sub_61a800(int32_t* arg1)
{
        ...
        if (i_1 != 0)
            ...
            do
                ...
                if ((ecx & 0x30) != 0 && eax_14 u< 0xff)
                    esi_2 = eax_14 * esi_2 u/ 0xff
                    ebx_1 = var_14_1 * ebx_1 u/ 0xff
                    eax_14 = var_14_1
                    var_c_1 = var_14_1 * var_c_1 u/ 0xff
                
                if (ecx_1 == 0x10)
                    var_8_1 = (0xff - eax_14) * var_8_1 u/ 0xff + ebx_1
                    edi_1 = (0xff - eax_14) * edi_1 u/ 0xff + esi_2
                    ecx_7 = (0xff - eax_14) * ecx_7 u/ 0xff + var_c_1
                else if (ecx_1 == 0x20)
                    edi_1 += esi_2
                    ...
                    edi_1 = edi_1 * esi_2 u/ 0xff
                    ecx_7 = ecx_7 * var_c_1 u/ 0xff
