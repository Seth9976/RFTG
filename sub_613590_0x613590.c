...
int32_t*sub_613590(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                uint32_t esi_1 = zx.d((eax_9 u>> 8).b)
                ...
                if ((ecx & 2) == 0)
                    ...
                    edx_23 = edx_3 * 0xff u/ 0xff
                    var_14_1 = edx_23
                
                if ((ecx & 0x30) != 0 && edx_23 u< 0xff)
                    edi_1 = edx_23 * edi_1 u/ 0xff
                    ebx_1 = var_14_1 * ebx_1 u/ 0xff
                    var_c_1 = var_14_1 * var_c_1 u/ 0xff
                    edx_23 = var_14_1
                
                if (ecx_1 == 0x10)
                    ecx_5 = edi_1 + (0xff - edx_23) * ecx_5 u/ 0xff
                    esi_1 = (0xff - edx_23) * esi_1 u/ 0xff + ebx_1
                    var_8_1 = (0xff - edx_23) * var_8_1 u/ 0xff + var_c_1
                else if (ecx_1 == 0x20)
                    ecx_5 += edi_1
                ...
                var_18_1 = &var_18_1[1]
                *var_1c_1 = (ecx_5 << 8 | esi_1) << 8 | var_8_1
                var_1c_1 = &var_1c_1[1]
            while (i != 0)
