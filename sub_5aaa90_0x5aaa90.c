...
long doublesub_5aaa90(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, double arg3)
{
    ...
    if (data_3166ed8 != 0)
        ...
        if (not(cond:0_1))
            ...
            int32_t xmm2[0x4] = data_6b03a0
            int64_t xmm7 = xmm0.q
            uint64_t xmm0_1[0x2] = _mm_srli_epi64(xmm0, 0x34)
            int32_t eax_3 = xmm0_1
            int32_t xmm2_1[0x4] = _mm_sub_epi32(xmm2, __andpd_xmmxuq_memxuq(xmm0_1, data_6b03c0))
            ...
            if ((eax_3 & 0x800) == 0)
                ...
                if (eax_3 s< 0x3ff)
                    arg3 = __andpd_xmmxuq_memxuq(__cmppd_xmmpd_mempd_immb(xmm0_3, data_6b03b0, 6), 
                        data_6b0390)
                    return fconvert.t(arg3)
                
                if (eax_3 s<= 0x432)
                    arg3 = xmm1_3 f+ __andpd_xmmxuq_memxuq(xmm0_4, data_6b0390)
                    return fconvert.t(arg3)
            else
                if (eax_3 s< 0xbff)
            ...
            if (not(is_ordered.q(xmm7, xmm7)))
                ...
                sub_5b50b6(&arg3, &arg3, &arg3, 0x3ec)
    ...
    return sub_5b4c6c(var_30_1, 0xc, var_28_1)
}
