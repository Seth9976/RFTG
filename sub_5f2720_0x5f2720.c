...
int32_tsub_5f2720(int32_t arg1, int32_t arg2)
{
    ...
    edi.w = *(ecx_1 + 6)
    edi.w = rol.w(edi.w, 8)
    int32_t var_c = sx.d(rol.w(*(esi + ecx - 4), 8))
    int32_t var_10 = sx.d(rol.w(*(ecx_1 + 2), 8))
    void* eax_1 = esi + eax - 0x10
    int32_t var_1c = esi
    int32_t edi_1 = sx.d(edi.w)
    int32_t var_14 = sx.d(rol.w(*ecx_1, 8))
    int32_t var_18
    int32_t var_8
