...
int32_t __convention("regparm")sub_491e50(int32_t arg1, void* arg2, int32_t arg3, int32_t arg4, int32_t arg5, int32_t arg6)
{
    ...
    do
        ...
        if (ebx s>= 4)
            ...
            do
                ...
                *(data_2691bfc + (result << 3)) = fconvert.d(float.t(ebx_1 * 2 - 1))
                int32_t ebx_3
                ebx_3.b = eax_3 - 1 s< esi
                *(data_2691bfc + (result << 3) + 8) = fconvert.d(float.t(ebx_3 * 2 - 1))
                int32_t edx_10
                edx_10.b = eax_3 s< esi
                *(data_2691bfc + (result << 3) + 0x10) = fconvert.d(float.t(edx_10 * 2 - 1))
                int32_t ebx_5
                ...
                i_1 = i_4
                i_4 -= 1
                *(data_2691bfc + (result << 3) - 8) = fconvert.d(float.t(ebx_5 * 2 - 1))
            while (i_1 != 1)
            ebx = arg6
            edx_3 = var_8
            ecx_8 = edx_5
        ...
        if (ecx_8 s< ebx)
            ...
            do
                ...
                i_2 = i_5
                i_5 -= 1
                *(data_2691bfc + (result << 3) - 8) = fconvert.d(float.t(ecx_9 * 2 - 1))
            while (i_2 != 1)
            ebx = arg6
