...
int32_tsub_57b610()
{
    ...
    if (result != 0)
        ...
        if (result != 1)
            ...
            x87_r7_2 = fconvert.t(*(eax_4 + 0x18)) + fconvert.t(*(eax_4 + 0x10))
        else
            ...
            if (eax_2 == 0)
                ...
                edx_1 = *(eax_5 + 0x14)
                int32_t var_50_1 = *(eax_5 + 8)
                x87_r7_2 = fconvert.t(*(eax_5 + 0xc)) + fconvert.t(edx_1)
                int32_t var_48_1 = *(eax_5 + 0x10)
            else
                int32_t* eax_3
        ...
        if (data_273bc2c s> 0)
            ...
            do
                ...
                long double x87_r6_3 = fconvert.t(fconvert.s(fconvert.t(var_54_1) - fconvert.t(fconvert
                    .s((fconvert.t(*(ebx_3 + esi_3 + 0x18)) + fconvert.t(*(ebx_3 + esi_3 + 0x10)))
                    * fconvert.t(0.5)))))
                float var_1c = fconvert.s(fconvert.t(*(ebx_4 + 0xc)) + x87_r6_1)
                float var_18_1 = fconvert.s(x87_r6_3 + fconvert.t(*(ebx_4 + 0x10)))
                float var_14_1 = fconvert.s(x87_r6_1 + fconvert.t(*(ebx_4 + 0x14)))
                float var_10_1 = fconvert.s(x87_r6_3 + fconvert.t(*(ebx_4 + 0x18)))
                void var_30
