...
int32_tsub_5e5850(int32_t arg1, int32_t arg2)
{
        ...
        do
            ...
            *edx = rol.w(var_20, 8)
            ...
            if (esi * 2 s>= eax_17)
                ...
                ecx_1 -= 0x10
                edi_1 = ((sx.d(rol.w(eax_18, 8)) + sx.d(edi_1)) s>> 1).w
                var_8 = ((sx.d(rol.w(ecx_1[6], 8)) + sx.d(var_8)) s>> 1).w
                var_c = ((sx.d(rol.w(ecx_1[5], 8)) + sx.d(var_c)) s>> 1).w
                var_10 = ((sx.d(rol.w(ecx_1[4], 8)) + sx.d(var_10)) s>> 1).w
                var_14 = ((sx.d(rol.w(ecx_1[3], 8)) + sx.d(var_14)) s>> 1).w
                var_18 = ((sx.d(rol.w(ecx_1[2], 8)) + sx.d(var_18)) s>> 1).w
                var_1c = ((sx.d(rol.w(ecx_1[1], 8)) + sx.d(var_1c)) s>> 1).w
                var_20 = ((sx.d(rol.w(*ecx_1, 8)) + sx.d(var_20)) s>> 1).w
                eax_17 = eax_1
                esi -= eax_17
        while (edx u>= ecx)
