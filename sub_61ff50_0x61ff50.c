            ...
            *(esi + 0x1c) -= 1
            ...
            if (edx_5 != 0)
                ...
                while (true)
                    ...
                    uint32_t var_c_1 = zx.d((eax_19 u>> 0x10).b)
                    uint32_t edi_4 = eax_19 u>> 0x18
                    uint32_t ebx_3 = zx.d((eax_19 u>> 8).b)
                    uint32_t ecx_10 = zx.d(eax_19.b)
                    
                    if (edx_7 != 0)
                        ebx_3 = ebx_3 * eax u/ 0xff
                        var_c_1 = var_c_1 * ecx u/ 0xff
                        edi_4 = edi_4 * edx u/ 0xff
                    
                    if ((ebx_1 & 2) != 0)
                        ecx_10 = ecx_10 * eax_1 u/ 0xff
                    
                    edi_1 = var_10_1 + result_1
                    *var_20_1 = ((ecx_10 << 8 | ebx_3) << 8 | var_c_1) << 8 | edi_4
                    var_10_1 = edi_1
                    var_20_1 += 4
