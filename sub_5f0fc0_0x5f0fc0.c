...
int32_tsub_5f0fc0(uint32_t arg1, int32_t arg2)
{
    // 第一条实际指令: uint32_t ecx = arg1
    uint32_t ecx = arg1
    int32_t edx = *(ecx + 0x18)
    int32_t ebx = edx << 2
    uint32_t esi = *(ecx + 0x10)
    int16_t* edi = esi + edx - 8
    uint32_t var_8 = zx.d(rol.w(edi[3], 8))
    uint32_t var_c = zx.d(rol.w(edi[2], 8))
    uint32_t var_10 = zx.d(rol.w(edi[1], 8))
    void* eax = esi + ebx - 0x20
    int32_t var_24 = ebx
    uint32_t var_20 = esi
    uint32_t var_14 = zx.d(rol.w(*edi, 8))
    void* var_1c
    uint32_t var_18
