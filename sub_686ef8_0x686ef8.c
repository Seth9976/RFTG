...
long double __convention("regparm")sub_686ef8(int32_t arg1, int16_t arg2 @ x87control, long double arg3 @ st0, int32_t arg4)
{
    // 第一条实际指令: int32_t edx
    int32_t edx
    int32_t var_4 = edx
    ...
    if (z)
        ...
        if (data_bec5f8 == 0)
            return __startOneArgErrorHandling(eax, 0x1e, result, &data_8bc0b0, var_4)
    else
        int16_t x87control
        int16_t x87status_1
        ...
        if (data_bec5f8 == 0)
            ...
            if (arg1.w != 0x27f)
                ...
                if (arg1.w != 0)
                    ...
                    if (arg1.w != 0)
                        return __startOneArgErrorHandling(8, 0x1e, result, &data_8bc0b0, var_4)
