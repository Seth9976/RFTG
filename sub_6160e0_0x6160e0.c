...
int32_t*sub_6160e0(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                int32_t eax_8 = *var_1c_1
                uint32_t ebx_1 = zx.d((eax_7 u>> 8).b)
                uint32_t esi_1 = zx.d(eax_8.b)
                uint32_t var_14_1 = 0xff
                uint32_t ecx_8 = zx.d((eax_8 u>> 0x10).b)
                uint32_t var_8_1 = zx.d((eax_8 u>> 8).b)
                ...
                if ((ecx & 2) == 0)
                    ...
                    edx_22 = edx_3 * 0xff u/ 0xff
                    var_14_1 = edx_22
                
                if ((ecx & 0x30) != 0 && edx_22 u< 0xff)
                    edi_1 = edx_22 * edi_1 u/ 0xff
                    ebx_1 = var_14_1 * ebx_1 u/ 0xff
                    var_c_1 = var_14_1 * var_c_1 u/ 0xff
                    edx_22 = var_14_1
                
                if (ecx_1 == 0x10)
                    var_8_1 = (0xff - edx_22) * var_8_1 u/ 0xff + ebx_1
                    esi_1 = (0xff - edx_22) * esi_1 u/ 0xff + edi_1
                    ecx_8 = (0xff - edx_22) * ecx_8 u/ 0xff + var_c_1
                else if (ecx_1 == 0x20)
                    esi_1 += edi_1
                    ...
                    ecx_8 = ecx_8 * var_c_1 u/ 0xff
                
                var_18_1 = &var_18_1[1]
                *var_1c_1 = (ecx_8 << 8 | var_8_1) << 8 | esi_1
                var_1c_1 = &var_1c_1[1]
            while (i != 0)
