...
long doublesub_5ff9b0(void* arg1, int32_t arg2)
{
    ...
    if (eax_2 u< edi)
        ...
        void* esi_2 = &eax_2[2]
        void* ecx_25 = &eax_2[2]
        int32_t i_1 = (edi - eax_2 - 1) u/ 0x18 + 1
        int32_t i
        ...
        do
            ...
            ecx_25 += 0x60
            esi_2 += 0x18
            float var_1c_1 = fconvert.s(fconvert.t(*(ecx_25 - 0x54)))
            i = i_1
            i_1 -= 1
