...
void*sub_5fc1a0(void* arg1, int32_t arg2)
{
    ...
    if (i u< edi)
        ...
        int32_t eax_9
        int32_t edx_6
        edx_6:eax_9 = sx.q(edi - i + 3)
        
        if ((eax_9 + (edx_6 & 3)) s>> 2 s>= 4)
            do
                ...
                *i = fconvert.s((x87_r7_1 + x87_r5_2) * x87_r6_1)
                float var_8_4 = fconvert.s(fconvert.t(i_1[2]))
                ...
                *(i + 4) = fconvert.s((x87_r5_2 + x87_r5_6) * x87_r6_1)
                float var_8_6 = fconvert.s(fconvert.t(i_1[4]))
                ...
                *(i + 8) = fconvert.s((x87_r5_6 + x87_r5_10) * x87_r6_1)
                float var_8_8 = fconvert.s(fconvert.t(i_1[6]))
