...
int32_tsub_4218c0(int32_t arg1, int32_t arg2, float arg3)
{
    // 第一条实际指令: int32_t var_c = 0xffffffff
    int32_t var_c = 0xffffffff
    int32_t (* var_10)(void* arg1) = sub_6952be
    TEB* fsbase
    ...
    if ((data_3165e38 & 1) == 0)
        data_3165e38.d |= 1
        int32_t var_c_1 = 0
        data_3165e34 = sub_4f5220(data_307c5a4, "animPhaseVisibity")
    ...
    while (true)
        ...
        if (not(cond:3_1))
            ...
            if (sub_4faeb0(data_3165e34, edx_5, esi_4, fconvert.s(fconvert.t(arg3))) == 0)
                fsbase->NtTib.ExceptionList = ExceptionList
                return 0
