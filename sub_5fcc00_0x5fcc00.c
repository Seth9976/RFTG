...
long doublesub_5fcc00(void* arg1, int32_t arg2)
{
    ...
    if (i u>= edi)
        ...
        int32_t eax_11
        int32_t edx_11
        edx_11:eax_11 = sx.q(edi - i + 7)
        
        if ((eax_11 + (edx_11 & 7)) s>> 3 s>= 4)
            do
        ...
        if (i u< edi)
            while (true)
                ...
                float var_c_11 = fconvert.s(fconvert.t(i_1[-3]))
