...
int32_t*sub_619550(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                if (eax_3 == 0x10)
                    ecx_6 = esi_2 + (0xff - edx_5) * ecx_6 u/ 0xff
                    ebx_3 = (0xff - edx_5) * ebx_3 u/ 0xff + var_14_1
                    var_8_1 = (0xff - edx_5) * var_8_1 u/ 0xff + var_c_1
                else if (eax_3 == 0x20)
                    ecx_6 += esi_2
                    ...
                    uint32_t eax_17 = var_8_1 + var_c_1
                    var_8_1 = eax_17
                    
                    if (eax_17 u> 0xff)
                        var_8_1 = 0xff
                else if (eax_3 == 0x40)
                    ecx_6 = ecx_6 * esi_2 u/ 0xff
                    ebx_3 = ebx_3 * edi_1 u/ 0xff
                    var_8_1 = var_8_1 * var_c_1 u/ 0xff
                
                var_18_1 = &var_18_1[1]
                *var_1c_1 = (ecx_6 << 8 | ebx_3) << 8 | var_8_1
                var_1c_1 = &var_1c_1[1]
            while (i != 0)
