            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_14_1 != 0)
                ...
                while (true)
                    ...
                    if (eax_12 == 0x10)
                        ecx_6 = edi_3 + (0xff - edx_10) * ecx_6 u/ 0xff
                        ebx_3 = (0xff - edx_10) * ebx_3 u/ 0xff + var_20_1
                        var_8_1 = (0xff - edx_10) * var_8_1 u/ 0xff + var_c_1
                    else if (eax_12 == 0x20)
                        ecx_6 += edi_3
                        ...
                        uint32_t eax_32 = var_8_1 + var_c_1
                        var_8_1 = eax_32
                        
                        if (eax_32 u> 0xff)
                            var_8_1 = 0xff
                    else if (eax_12 == 0x40)
                        ecx_6 = ecx_6 * edi_3 u/ 0xff
                        ebx_3 = ebx_3 * esi_3 u/ 0xff
                        var_8_1 = var_8_1 * var_c_1 u/ 0xff
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_6 << 8 | ebx_3) << 8 | var_8_1
                    var_10_1 += result_1
                    ecx = arg1
                    result_2 = result
