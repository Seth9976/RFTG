...
int32_tsub_5eef70(void* arg1, int32_t arg2)
{
    ...
    uint32_t ebx = zx.d(*(ecx_1 + 0xe))
    uint32_t var_34 = zx.d(*(esi + ecx - 4))
    uint32_t var_c = zx.d(*(ecx_1 + 0xa))
    uint32_t var_14 = zx.d(*(ecx_1 + 8))
    uint32_t var_1c = zx.d(*(ecx_1 + 6))
    uint32_t var_24 = zx.d(*(ecx_1 + 4))
    uint32_t var_2c = zx.d(*(ecx_1 + 2))
    int16_t* eax_1 = esi + eax - 0x40
    uint32_t var_3c = ebx
    uint32_t var_30 = zx.d(*ecx_1)
    uint32_t var_38
    uint32_t var_28
    uint32_t var_20
    uint32_t var_18
    ...
    if (eax_1 u>= esi)
        do
            var_8 = zx.d(*(ecx_1 + 0xa))
            var_10 = zx.d(*(ecx_1 + 8))
            var_18 = zx.d(*(ecx_1 + 6))
            var_20 = zx.d(*(ecx_1 + 4))
            uint32_t edx_1 = zx.d(*(ecx_1 + 0xe))
            var_28 = zx.d(*(ecx_1 + 2))
            var_38 = zx.d(*ecx_1)
            uint32_t esi_1 = zx.d(*(ecx_1 + 0xc))
