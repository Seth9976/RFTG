...
int80_t __convention("regparm")sub_430300(int32_t arg1, int32_t arg2, int32_t arg3, float* arg4, int32_t arg5, char arg6)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_69228c
    TEB* fsbase
    ...
    if (not(cond:2))
        data_3165738.d |= 1
        int32_t var_8_1 = 0
        data_3165734 = sub_4f5220(data_307c758, "tbl_Card")
    ...
    int32_t eax_7
    int80_t result
    result, eax_7 = sub_4f66d0(&var_100, data_307c758, data_3165734, &data_84074c, 
        fconvert.s(float.t(1)), nullptr, nullptr)
    bool cond:1 = (data_3165738 & 2) != 0
    __builtin_memcpy(&var_58, eax_7, 0x40)
    
    if (not(cond:1))
        data_3165738.d |= 2
        int32_t var_8_3 = 1
        data_3165730 = sub_4f5220(data_307c104, "Takeover")
        int32_t var_8_4 = 0xffffffff
    
    int32_t* eax_10 = sub_4f5350(data_3165730, &var_58, data_307c104, &var_58)
    float ecx_7 = *eax_10
    ...
    long double x87_r5_3 = fconvert.t(var_5c) / fconvert.t(data_307cc8c)
    *arg4 = fconvert.s(x87_r5_3 + x87_r5_3)
    fsbase->NtTib.ExceptionList = ExceptionList
