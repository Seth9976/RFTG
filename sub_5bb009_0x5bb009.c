...
int32_tsub_5bb009(int32_t arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t esi_2 = (arg1 & 0x1f) << 6
    int32_t esi_2 = (arg1 & 0x1f) << 6
    void* ecx_1 = (&data_3166ee0)[arg1 s>> 5] + esi_2
    int32_t eax_1
    eax_1.b = *(ecx_1 + 0x24)
    eax_1.b *= 2
    int32_t edi
    ...
    if (arg2 == 0x4000)
        *(ecx_1 + 4) |= 0x80
        char* ecx_6 = (&data_3166ee0)[arg1 s>> 5] + esi_2 + 0x24
        *ecx_6 &= 0x80
    else if (arg2 == 0x8000)
        *(ecx_1 + 4) &= 0x7f
    else
        ...
        if (arg2 == 0x10000 || arg2 == 0x20000)
            *(ecx_1 + 4) |= 0x80
            ecx_3 = (&data_3166ee0)[arg1 s>> 5] + esi_2 + 0x24
            edx.b = *ecx_3
            edx.b &= 0x82
            edx.b |= 2
            *ecx_3 = edx.b
