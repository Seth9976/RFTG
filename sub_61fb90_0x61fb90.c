            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    if (eax_12 == 0x10)
                        ebx_1 = (0xff - edx_11) * ebx_1 u/ 0xff + var_10_1
                        var_8_1 = (0xff - edx_11) * var_8_1 u/ 0xff + var_14_1
                        var_c_1 = (0xff - edx_11) * var_c_1 u/ 0xff + edi_3
                        ...
                        uint32_t eax_32 = var_8_1 + var_14_1
                        var_8_1 = eax_32
                        
                        if (eax_32 u> 0xff)
                            var_8_1 = 0xff
                        
                        uint32_t eax_34 = var_c_1 + edi_3
                        var_c_1 = eax_34
