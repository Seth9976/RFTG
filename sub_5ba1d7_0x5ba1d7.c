...
int32_tsub_5ba1d7(int16_t* arg1, int32_t* arg2)
{
    ...
    if (ebx_2 != 0xffffc001)
        ...
        *(edi_4 + 4) = esi_1[1]
        ...
        int32_t eax_19 = data_8b9244
        
        if (ebx_2 s< eax_19 - data_8b9248)
            var_14 = 0
            ...
            *edi_17 = 0
            ...
            int32_t ecx_34 = data_8b924c
            
            if (ebx_2 s< data_8b9240)
                ebx_3 = ebx_2 + data_8b9254
                var_14 &= 0x7fffffff
                int32_t eax_44
                int32_t edx_48
    ...
    int32_t ecx_54 = data_8b9250
    int32_t ebx_14 =
        ebx_3 << (0x1f - (data_8b924c).b) | (sbb.d(ecx_51, ecx_51, ecx_2 != 0) & 0x80000000) | var_14
