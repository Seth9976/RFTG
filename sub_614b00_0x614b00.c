            ...
            *(esi + 0x1c) -= 1
            ...
            if (edx_4 != 0)
                ...
                while (true)
                    ...
                    uint32_t edi_3 = zx.d((eax_18 u>> 0x10).b)
                    uint32_t ebx_3 = zx.d((eax_18 u>> 8).b)
                    uint32_t var_c_1 = zx.d(eax_18.b)
                    uint32_t ecx_9 = 0xff
                    ...
                    if ((ebx_1 & 2) != 0)
                        ecx_9 = eax_1 * 0xff u/ 0xff
                    
                    edi_1 = var_10_1 + result_1
                    result = result_2 + 4
                    *(result - 4) = ((ecx_9 << 8 | edi_3) << 8 | ebx_3) << 8 | var_c_1
                    var_10_1 = edi_1
                    result_2 = result
