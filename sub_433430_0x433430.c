...
int80_t __convention("regparm")sub_433430(int32_t arg1, int32_t arg2, int32_t arg3, void* arg4, char* arg5)
{
    // 第一条实际指令: int32_t var_c = 0xffffffff
    int32_t var_c = 0xffffffff
    int32_t (* var_10)(void* arg1) = sub_69507a
    TEB* fsbase
    ...
    if ((data_3165dd8 & 1) == 0)
        ...
        data_3165dd4 = sub_510710(data_307ca3c, edx_1)
        int32_t var_c_2 = 0xffffffff
    
    data_3092a04
    float var_80
    float var_3c[0x8]
    sub_50d8d0(&var_3c, sub_50eb00(data_3165dd4, 0), &var_80, eax_11, &var_3c)
    int32_t eax_17
    int32_t edx_5
    ...
    char* edi_1 = *(sub_4f7720(var_124, ebx_4, eax_23) + 0x434)
    
    if ((data_3165dd8 & 4) == 0)
        data_3165dd8.d |= 4
        int32_t var_c_5 = 2
        data_3165dcc = sub_4f5220(data_307c758, "img_Good")
    ...
    int32_t* var_138_8 = &var_120
    long double x87_r5_3 = fconvert.t(*(eax_28 + 0x14)) - fconvert.t(ecx_7)
    int32_t eax_30 = data_3165dcc
    var_120 = var_90_2
    int32_t* var_8c = fconvert.s(x87_r5_3)
    float* var_13c_6 = &var_80
    int32_t* var_11c_1 = var_8c
    var_140 = edi_1
    void var_d0
    __builtin_memcpy(&var_80, sub_4fa9f0(eax_30, var_8c, var_90_2, &var_d0, var_140), 0x40)
