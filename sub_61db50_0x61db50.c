            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_20_1 != 0)
                ...
                while (true)
                    ...
                    if (eax_18 == 0x10)
                        var_8_1 = (0xff - edi_2) * var_8_1 u/ 0xff + ebx_2
                        var_c_1 = (0xff - edi_2) * var_c_1 u/ 0xff + var_10_1
                        ecx_5 = edi_2 + (0xff - edi_2) * ecx_5 u/ 0xff
                        esi_3 = (0xff - edi_2) * esi_3 u/ 0xff + var_14_1
                    else if (eax_18 == 0x20)
