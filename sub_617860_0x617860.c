...
int32_t*sub_617860(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                uint32_t var_10_1 = zx.d(eax_7.b)
                ...
                if ((ecx & 1) != 0)
                    ...
                    var_10_1 = var_10_1 * edx_2 u/ 0xff
                
                if ((ecx & 2) != 0)
                    esi_2 = esi_2 * edx_3 u/ 0xff
                
                if ((ecx & 0x30) != 0 && esi_2 u< 0xff)
                    ebx_1 = ebx_1 * esi_2 u/ 0xff
                    var_c_1 = var_c_1 * esi_2 u/ 0xff
                    var_10_1 = var_10_1 * esi_2 u/ 0xff
                
                if (ecx_1 == 0x10)
                    ecx_7 = ebx_1 + (0xff - esi_2) * ecx_7 u/ 0xff
                    edi_1 = (0xff - esi_2) * edi_1 u/ 0xff + var_c_1
                    ...
                    uint32_t eax_23 = var_8_1 + var_10_1
                    var_8_1 = eax_23
                    
                    if (eax_23 u> 0xff)
                        var_8_1 = 0xff
                else if (ecx_1 == 0x40)
                    ecx_7 = ecx_7 * ebx_1 u/ 0xff
