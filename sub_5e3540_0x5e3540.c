...
int32_tsub_5e3540(void* arg1, int32_t arg2)
{
    ...
    if (ecx u< i)
        ...
        do
            ...
            if (eax_10 * 2 s>= eax - 0x100)
                ...
                *(ecx_1 - 4) = esi
                *(ecx_1 - 2) = edi
                esi = ((zx.d(*(edx - 4)) + zx.d(esi)) s>> 1).w
                edi = ((zx.d(*(edx - 2)) + zx.d(edi)) s>> 1).w
                var_20 = ((zx.d(*edx) + zx.d(var_20)) s>> 1).w
                var_c = ((zx.d(*(edx + 2)) + zx.d(var_c)) s>> 1).w
                var_10 = ((zx.d(*(edx + 4)) + zx.d(var_10)) s>> 1).w
                var_14 = ((zx.d(*(edx + 6)) + zx.d(var_14)) s>> 1).w
                var_18 = ((zx.d(*(edx + 8)) + zx.d(var_18)) s>> 1).w
                var_1c = ((zx.d(*(edx + 0xa)) + zx.d(var_1c)) s>> 1).w
                ecx_1 += 0x10
                var_8 -= eax - 0x100
        while (ecx_1 - 4 u< i)
