...
int32_tsub_4b9120(int32_t arg1 @ esi)
{
    // 第一条实际指令: int32_t* ecx_2 = data_27e7a44
    int32_t* ecx_2 = data_27e7a44
    ...
    if (arg1 != 0)
        ...
        if (eax_3 u< ecx_2[1])
            ...
            if (*(eax_3 * 0x1f8 + edx_1 + 0x1f0) == arg1)
                return eax_3 * 0x1f8 + edx_1
        
        char const* const var_4_1 = "DataArray<struct SGame>::DataArrayGet"
        var_8 = 0x46
        char const* const var_c_1 = "c:\ax2010\engine\DataArray.h"
        char* const var_10_1 = &data_83f3d3
        var_14 = "DataArrayTryToGet(id) != NULL"
    else
        char const* const var_4 = "DataArray<struct SGame>::DataArrayGet"
        var_8 = 0x45
    ...
    sub_4c5870(var_14, &data_83f3d3, "c:\ax2010\engine\DataArray.h", var_8, 
        "DataArray<struct SGame>::DataArrayGet")
