...
int80_t __convention("regparm")sub_4670e0(int32_t arg1, int32_t arg2, int32_t arg3, int32_t* arg4, char arg5)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_6920dc
    TEB* fsbase
    ...
    if ((data_31656f0 & 1) == 0)
        data_31656f0.d |= 1
        int32_t var_8_1 = 0
        data_31656ec = sub_4f5220(data_307c530, "rgn_playerTableau")
        int32_t var_8_2 = 0xffffffff
    
    if ((data_31656f0 & 2) == 0)
        data_31656f0.d |= 2
        int32_t var_8_3 = 1
        data_31656e8 = sub_4f5220(data_307c104, "Card")
    ...
    if (p)
        sub_4c5870("SqrLen(t.offset) < 10000000", &data_83f3d3, "..\code\RftGLayout.cpp", 0x3d1, 
            "PlayerTableauCardRect")
    ...
    int32_t edx_4
    int80_t result
    result, eax_11, edx_4 = sub_4f66d0(&var_f4, data_307c530, data_31656ec, &var_6c, 
        fconvert.s(float.t(1)), &var_64, &var_58)
    __builtin_memcpy(&var_54, eax_11, 0x40)
    int32_t* eax_13 = sub_4f5350(data_31656e8, edx_4, data_307c104, &var_54)
    *arg4 = *eax_13
    arg4[1] = eax_13[1]
