            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_8_1 != 0)
                while (true)
                    ...
                    uint32_t edi_7 = zx.d(eax_14.b)
                    result = eax & 0x70
                    uint32_t ecx_8 = zx.d((eax_14 u>> 0x10).b)
                    uint32_t esi_2 = zx.d((eax_14 u>> 8).b)
                    ...
                    if (result == 0x10)
                        ...
                        ecx_8 = ecx_8 * edx_6 u/ 0xff
                        esi_2 = esi_2 * ecx_5 u/ 0xff
                        int32_t edx_11
                        edx_11:result = mulu.dp.d(0x80808081, edi_7 * eax_13)
                        edi_7 = edi_7 * eax_13 u/ 0xff
                    
                    edx_2 = var_1c_1 + result_1
                    uint32_t* esi_4 = var_28_1
                    *esi_4 = (ecx_8 << 8 | esi_2) << 8 | edi_7
                    ecx = arg1
                    esi_1 = &esi_4[1]
                    var_1c_1 = edx_2
                    var_28_1 = esi_1
