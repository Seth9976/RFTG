...
float __fastcallsub_40af40(float* arg1)
{
    ...
    if ((((x87_r6 < x87_r7 ? 1 : 0) << 8 | (is_unordered.t(x87_r6, x87_r7) ? 1 : 0) << 0xa
        ...
        if ((((x87_r6_1 < x87_r7_1 ? 1 : 0) << 8 | (is_unordered.t(x87_r6_1, x87_r7_1) ? 1 : 0) << 0xa
            ...
            float var_8 = fconvert.s(fconvert.t(arg1[1]))
            return fconvert.s(fconvert.t(*arg1))
    
    sub_4c5870("RectIsNormalized(r)", &data_83f3d3, "c:\ax2010\engine\Rect.cpp", 0x127, "RectTopLeft")
