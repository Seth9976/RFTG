...
long doublesub_5faf50(void* arg1, int32_t arg2)
{
    ...
    if (i u>= ebx)
        ...
        if ((ebx - i + 0x17) s/ 0x18 s>= 4)
            ...
            do
                ...
                *i = fconvert.s((result_5 + x87_r5_4) * result_1)
                ...
                long double x87_r5_7 = fconvert.t(i_1[0x18])
                long double x87_r4_3 = fconvert.t(i_1[0x19])
                long double x87_r3_3 = fconvert.t(i_1[0x1a])
                long double x87_r2_4 = fconvert.t(i_1[0x1b])
                long double x87_r1_20 = fconvert.t(i_1[0x1c])
                double var_10_2 = fconvert.d(fconvert.t(i_1[0x1d]))
                ...
                long double x87_r5_10 = fconvert.t(i_1[0x30])
                long double x87_r4_5 = fconvert.t(i_1[0x31])
                long double x87_r3_4 = fconvert.t(i_1[0x32])
                long double x87_r2_6 = fconvert.t(i_1[0x33])
                long double x87_r1_38 = fconvert.t(i_1[0x34])
                double var_10_3 = fconvert.d(fconvert.t(i_1[0x35]))
                ...
                x87_r5_13 = fconvert.t(i_1[0x48])
                x87_r4_7 = fconvert.t(i_1[0x49])
                result_8 = fconvert.t(i_1[0x4a])
                long double result_7 = fconvert.t(i_1[0x4b])
                x87_r1_56 = fconvert.t(i_1[0x4c])
                double var_10_4 = fconvert.d(fconvert.t(i_1[0x4d]))
        ...
        if (i u>= ebx)
            ...
            void* esi = &i_1[2]
            void* edi_1 = &i[2]
            int32_t edx_9 = (ebx - i - 1) u/ 0x18 + 1
            ...
            while (true)
                ...
                edi_1 += 0x18
                int32_t temp1_1 = edx_9
                edx_9 -= 1
                double var_18_4 = fconvert.d(fconvert.t(*(esi - 0x64)))
                double var_30_4 = fconvert.d(fconvert.t(*(esi - 0x60)))
                double var_28_4 = fconvert.d(fconvert.t(*(esi - 0x5c)))
                double var_20_4 = fconvert.d(fconvert.t(*(esi - 0x58)))
                double var_10_5 = fconvert.d(fconvert.t(*(esi - 0x54)))
