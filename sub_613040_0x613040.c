...
int32_t*sub_613040(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i != 0)
            ...
            do
                ...
                int32_t eax_5 = *esi_1
                uint32_t edi_1 = zx.d(eax_5.b)
                uint32_t ecx_9 = zx.d((eax_5 u>> 0x10).b)
                uint32_t esi_2 = zx.d((eax_5 u>> 8).b)
                ...
                if (eax_1 == 0x10)
                    ...
                    ecx_9 = ecx_9 * edx_2 u/ 0xff
                    esi_2 = esi_2 * ecx_6 u/ 0xff
                    edi_1 = edi_1 * eax_4 u/ 0xff
                
                var_10_1 = &var_10_1[1]
                uint32_t* esi_4 = var_14_1
                *esi_4 = (ecx_9 << 8 | esi_2) << 8 | edi_1
                i -= 1
                esi_1 = &esi_4[1]
                var_14_1 = esi_1
            while (i != 0)
