...
int32_tsub_47ce00(int32_t* arg1)
{
    // 第一条实际指令: int32_t* esi = *arg1
    int32_t* esi = *arg1
    void* edi = data_27e7a50
    arg1 = esi
    long double x87_r6_2 = float.t(0)
    long double x87_r5 = fconvert.t(fconvert.s(fconvert.t(*(edi + 4)) * fconvert.t(9.0)))
    x87_r5 - x87_r6_2
    int32_t* eax
    ...
    *(edi + 4) = fconvert.s(float.t(arg1) / x87_r5)
    sub_408ca0()
    sub_408a40()
    return 0
}
