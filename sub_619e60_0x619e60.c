            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    if ((edi & 0x30) != 0 && eax_34 u< 0xff)
                        esi_4 = eax_34 * esi_4 u/ 0xff
                        ebx_2 = var_14_1 * ebx_2 u/ 0xff
                        eax_34 = var_14_1
                        var_c_1 = var_14_1 * var_c_1 u/ 0xff
                    
                    if (eax_18 == 0x10)
                        ecx_5 = esi_4 + (0xff - eax_34) * ecx_5 u/ 0xff
                        edi_1 = (0xff - eax_34) * edi_1 u/ 0xff + ebx_2
                        var_8_1 = (0xff - eax_34) * var_8_1 u/ 0xff + var_c_1
                    else if (eax_18 == 0x20)
                        ecx_5 += esi_4
                        ...
                        ecx_5 = ecx_5 * esi_4 u/ 0xff
                        edi_1 = edi_1 * ebx_2 u/ 0xff
                        var_8_1 = var_8_1 * var_c_1 u/ 0xff
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_5 << 8 | edi_1) << 8 | var_8_1
                    var_18_1 += result_1
                    ecx = arg1
                    result_2 = result
