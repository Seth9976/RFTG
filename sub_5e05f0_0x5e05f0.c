...
voidsub_5e05f0(void* arg1)
{
    ...
    if (i_2 != 0)
        ...
        do
            ...
            edx -= 2
            esi_1 -= 4
            float var_c_1 = fconvert.s(float.t(sx.d(i_2.w)) * fconvert.t(3.0518509447574615e-05))
            i = i_1
            i_1 -= 1
    ...
    *(edi + 0x50) += 1
    int32_t eax_3 = *(edi + 0x50)
    *(edi + 0x18) = ecx * 2
    
    if (*(edi + (eax_3 << 2) + 0x28) != 0)
        (*(edi + (eax_3 << 2) + 0x28))(edi, 0x9120)
}
