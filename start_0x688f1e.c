...
long doublestart(double arg1[0x2] @ xmm0, double arg2)
{
    ...
    while (true)
        ...
        uint64_t xmm3_1[0x2] = data_8371b0
        double xmm4_1[0x2] = data_837160
        uint64_t xmm6_1[0x2] = data_837170
        uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, data_837150), xmm3_1)
        eax_2 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
        double xmm4_3[0x2] = *(eax_2 + 0x837230)
        xmm7_1 = (*(eax_2 + 0x837640)).q
        ...
        double xmm0_10 = arg2
        double xmm1_10[0x2] = _mm_cmpeq_sd((data_8371c0).q, xmm0_10, 0)
        int32_t edx_2
        ...
        if ((ecx_1 & 0xfff) != 0)
            if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
                ...
                xmm1_10 = data_837150
                uint64_t xmm2_3[0x2] = data_8371b0
    ...
    double xmm2_1[0x2] = data_837210
    double xmm1_3[0x2] = _mm_mul_pd(data_837200, xmm0_5)
    double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
    double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_1)
    double xmm2_2[0x2] = data_837220
    double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_837180)
    uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0x837190))
