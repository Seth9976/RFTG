...
float*sub_431c80(float* arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t var_c = 0xffffffff
    int32_t var_c = 0xffffffff
    int32_t (* var_10)(void* arg1) = sub_692fcc
    TEB* fsbase
    ...
    if ((data_31658d8 & 1) == 0)
        ...
        char* edx
        data_31658d4 = sub_510710(data_307ca3c, edx)
    ...
    int32_t ecx_1
    char* edx_2
    eax_7, ecx_1, edx_2 = sub_50eb00(data_31658d4, arg2)
    ...
    if ((data_31658d8 & 2) == 0)
        ...
        int32_t eax_9
        eax_9, ecx_1 = sub_510710(data_307ca80, edx_2)
        data_31658d0 = eax_9
        int32_t var_c_4 = 0xffffffff
    
    int32_t edi_1 = data_31658d0
