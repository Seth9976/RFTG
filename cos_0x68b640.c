...
int32_t_cos(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, void arg3)
{
    ...
    if (data_3166ed8 != 0)
        ...
        if (not(cond:0_1))
            return sub_68ba88(arg3) __tailcall
    ...
    return sub_68b6d8(eax_4, arg2, st0, edx_1, ecx_2) __tailcall
}
