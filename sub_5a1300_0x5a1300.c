...
int32_t __convention("regparm")sub_5a1300(int16_t arg1, int32_t arg2, int32_t arg3, float arg4)
{
    ...
    if ((((x87_r6 < x87_r7 ? 1 : 0) << 8 | (is_unordered.t(x87_r6, x87_r7) ? 1 : 0) << 0xa
        ...
        var_10_1.q = fconvert.d(fconvert.t(fconvert.s((x87_r6 + x87_r6) / fconvert.t(arg4))))
