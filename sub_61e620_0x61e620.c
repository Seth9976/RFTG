...
int32_t*sub_61e620(int32_t* arg1)
{
        ...
        if (i_1 != 0)
            ...
            do
                ...
                if ((ecx & 0x30) != 0 && eax_15 u< 0xff)
                    ebx_1 = eax_15 * ebx_1 u/ 0xff
                    var_c_1 = var_14_1 * var_c_1 u/ 0xff
                    eax_15 = var_14_1
                    esi_2 = var_14_1 * esi_2 u/ 0xff
                
                if (ecx_1 == 0x10)
                    ecx_8 = ebx_1 + (0xff - eax_15) * ecx_8 u/ 0xff
                    edi_1 = (0xff - eax_15) * edi_1 u/ 0xff + var_c_1
                    var_8_1 = (0xff - eax_15) * var_8_1 u/ 0xff + esi_2
                else if (ecx_1 == 0x20)
                    ecx_8 += ebx_1
                    ...
                    uint32_t eax_23 = var_8_1 + esi_2
                    var_8_1 = eax_23
                    
                    if (eax_23 u> 0xff)
                        var_8_1 = 0xff
                else if (ecx_1 == 0x40)
                    ecx_8 = ecx_8 * ebx_1 u/ 0xff
                    edi_1 = edi_1 * var_c_1 u/ 0xff
                    var_8_1 = var_8_1 * esi_2 u/ 0xff
                
                var_18_1 = &var_18_1[1]
                *var_1c_1 = (ecx_8 << 8 | edi_1) << 8 | var_8_1
                var_1c_1 += 4
            while (i != 0)
