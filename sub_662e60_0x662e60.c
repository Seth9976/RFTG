...
int32_tsub_662e60(long double arg1 @ st0, int32_t arg2, int32_t arg3)
{
    // 第一条实际指令: int32_t ecx
    int32_t ecx
    int32_t var_8 = ecx
    ...
    if (result - 1 u<= 0xfffd)
        ...
        st0_1, x87control_2 = sub_686950(mxcsr, 
            sub_686c10(mxcsr, x87control, float.t(arg3) * fconvert.t(1.0000000000000001e-05), 
                x87_r7_1 / fconvert.t(65535.0)), 
            fconvert.d(arg1 * fconvert.t(65535.0) + fconvert.t(0.5)))
        int16_t x87status_1
        int16_t temp0_1
