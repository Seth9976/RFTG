...
int32_tsub_5f1160(void* arg1, int32_t arg2)
{
    ...
    uint32_t var_14 = zx.d(rol.w(esi[3], 8))
    uint32_t var_1c
    int32_t i_1
    uint32_t var_c
    ...
    if (esi u< edi)
        ...
        do
            uint32_t esi_1 = zx.d(rol.w(*(ecx_2 - 4), 8))
            uint32_t edi_5 = zx.d(rol.w(*(ecx_2 - 2), 8))
            var_c = zx.d(rol.w(*ecx_2, 8))
            var_1c = zx.d(rol.w(*(ecx_2 + 2), 8))
