...
int32_tsub_5f0720(void* arg1, int32_t arg2)
{
    ...
    int32_t var_18 = sx.d(esi[3])
    int32_t var_20 = sx.d(esi[4])
    int32_t var_28 = sx.d(esi[5])
    int32_t edx_3 = ((edx & 3) + eax_1) s>> 2
    int32_t var_30 = sx.d(esi[6])
    void* edi = esi + edx_3
    int32_t var_40 = edx_3
    int32_t var_34 = sx.d(esi[7])
    int32_t var_3c
    int32_t i_1
    int32_t var_2c
    int32_t var_24
    ...
    if (esi u< edi)
        ...
        do
            var_c = sx.d(*ecx_2)
            int32_t esi_1 = sx.d(*(ecx_2 - 4))
            var_14 = sx.d(*(ecx_2 + 2))
            var_1c = sx.d(*(ecx_2 + 4))
            int32_t edi_5 = sx.d(*(ecx_2 - 2))
            var_24 = sx.d(*(ecx_2 + 6))
            var_2c = sx.d(*(ecx_2 + 8))
            var_3c = sx.d(*(ecx_2 + 0xa))
