...
int32_t*sub_61f980(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                i -= 1
                uint32_t var_14_1 = zx.d((eax_5 u>> 0x10).b)
                uint32_t eax_6 = zx.d(eax_5.b)
                uint32_t var_10_1 = zx.d((eax_5 u>> 8).b)
                ...
                if (eax_3 == 0x10)
                    ebx_1 = (0xff - eax_6) * ebx_1 u/ 0xff + var_10_1
                    var_8_1 = (0xff - eax_6) * var_8_1 u/ 0xff + edi_2
                    ecx_7 = (0xff - eax_6) * ecx_7 u/ 0xff + eax_6
                    esi_1 = (0xff - eax_6) * esi_1 u/ 0xff + var_14_1
                else if (eax_3 == 0x20)
                    ebx_1 += var_10_1
