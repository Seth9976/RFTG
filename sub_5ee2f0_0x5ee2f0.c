...
int32_tsub_5ee2f0(void* arg1, int32_t arg2)
{
    ...
    uint32_t var_c = zx.d(*(esi + ecx - 4))
    uint32_t var_10 = zx.d(ecx_1[1])
    void* eax_1 = esi + eax - 0x10
    uint32_t edi = zx.d(ecx_1[3])
    uint32_t var_14 = zx.d(*ecx_1)
    uint32_t var_18
    uint32_t var_8
    
    if (eax_1 u>= esi)
        do
            uint32_t edx_1 = zx.d(ecx_1[3])
            uint32_t esi_1 = zx.d(ecx_1[2])
            var_8 = zx.d(ecx_1[1])
            uint32_t ebx_4 = zx.d(*ecx_1)
