...
int32_t*sub_5b080a(int32_t arg1, char* arg2, int32_t arg3, int32_t* arg4)
{
    // 第一条实际指令: int32_t ebx = 0
    int32_t ebx = 0
    char* esi = arg2
    int32_t var_8 = data_bed320
    int32_t var_10 = 0
    int32_t var_c = 0
    int32_t var_14 = 0
    ...
    if (eax.b != 0)
        while (true)
            ...
            if (__mbsnbset(esi_2, "UTF-8", 5) == 0)
                esi_1 = esi_2 + 5
                ebx |= 0x40000
                break
            
            if (__mbsnbset(esi_2, "UTF-16LE", 8) == 0)
                esi_1 = esi_2 + 8
                ebx |= 0x20000
                break
            
            if (__mbsnbset(esi_2, "UNICODE", 7) != 0)
                goto label_5b0a4d
