...
long doublesub_600160(void* arg1, int32_t arg2)
{
    ...
    if (esi u< edi)
        ...
        do
            ...
            *(edx_23 - 8) = fconvert.s((result + result_1) * result_2)
            *(edx_23 - 4) = fconvert.s((x87_r4_2 + fconvert.t(var_30)) * result_2)
            *edx_23 = fconvert.s((x87_r3_2 + fconvert.t(var_38)) * result_2)
            *(edx_23 + 4) = fconvert.s((fconvert.t(var_40) + x87_r2_2) * result_2)
            *(edx_23 + 8) = fconvert.s((x87_r1_2 + fconvert.t(var_48)) * result_2)
            edx_23 += 0x20
            i = i_1
            i_1 -= 1
            *(edx_23 - 0x14) = fconvert.s((fconvert.t(var_50) + fconvert.t(var_58)) * result_2)
            *(edx_23 - 0x10) = fconvert.s((fconvert.t(var_60) + fconvert.t(var_68)) * result_2)
            *(edx_23 - 0xc) = fconvert.s((fconvert.t(var_70) + fconvert.t(var_78)) * result_2)
