            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    if ((edi & 2) == 0)
                        ...
                        edx_27 = edx_1 * 0xff u/ 0xff
                        var_14_1 = edx_27
                    
                    if ((edi & 0x30) != 0 && edx_27 u< 0xff)
                        edi_1 = edx_27 * edi_1 u/ 0xff
                        ebx_2 = var_14_1 * ebx_2 u/ 0xff
                        var_c_1 = var_14_1 * var_c_1 u/ 0xff
                        edx_27 = var_14_1
                    
                    if (eax_18 == 0x10)
                        var_8_1 = (0xff - edx_27) * var_8_1 u/ 0xff + ebx_2
                        esi_3 = (0xff - edx_27) * esi_3 u/ 0xff + edi_1
                        ecx_5 = (0xff - edx_27) * ecx_5 u/ 0xff + var_c_1
                    else if (eax_18 == 0x20)
                        esi_3 += edi_1
