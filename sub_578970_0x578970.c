...
int32_tsub_578970()
{
    ...
    void* eax_2 = sub_4f4890(data_273ac20)
    ...
    double var_114 = fconvert.d(fconvert.t(*(eax_2 + 0x10)) - fconvert.t(var_9c))
    double var_14c = fconvert.d(fconvert.t(*(eax_2 + 0x14)) - fconvert.t(edx))
    float var_f4
    void arg_4
    
    do
        long double x87_r7_7 = fconvert.t(8.0)
        long double x87_r5_1 = fconvert.t(data_27bc43c)
        long double x87_r6_17 = fconvert.t(fconvert.s(fconvert.t(fconvert.s(fconvert.t(fconvert.s(
            ...
            - fconvert.t(data_27bc440))) * x87_r5_1))
    ...
    "07\x00\x00\x00\x06\x00\x00\x00", 
        0x20)
    float var_15c
    float* eax_6 = sub_5757f0(&var_15c, &var_9c)
    float ecx_4 = *eax_6
    float edx_4 = eax_6[1]
    float ecx_5 = eax_6[2]
    float edx_5 = eax_6[3]
    ...
    do
        ...
        long double x87_r5_9 = fconvert.t(data_27bc440)
        long double x87_r4_5 = fconvert.t(data_27bc444)
        long double x87_r3_2 = fconvert.t(data_27bc43c)
