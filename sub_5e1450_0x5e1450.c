...
voidsub_5e1450(int16_t arg1 @ x87control, void* arg2)
{
    ...
    if (i_1 != 0)
        ...
        do
            ...
            *(esi - 2) = (int.d((fconvert.t(((var_c_1 & 0xff0000) | var_c_1 u>> 0x10) u>> 8
                | ((var_c_1 & 0xff00) | var_c_1 << 0x10) << 8) + float.t(1)) * fconvert.t(32767.0))).w
            int16_t x87status_3
    ...
    *(edi + 0x18) = (eax_6 - edx_1) s>> 1
    int32_t eax_9 = *(edi + 0x50)
    
    if (*(edi + (eax_9 << 2) + 0x28) != 0)
        (*(edi + (eax_9 << 2) + 0x28))(edi, 0x10)
}
