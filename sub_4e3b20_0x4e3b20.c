...
int32_t __fastcallsub_4e3b20(float* arg1, float* arg2)
{
    // 第一条实际指令: long double x87_r7 = fconvert.t(arg2[3])
    long double x87_r7 = fconvert.t(arg2[3])
    long double x87_r6 = fconvert.t(arg1[3])
    x87_r6 - x87_r7
    int32_t result
    ...
    if (not(p))
        ...
        if (not(p_1))
            ...
            if (not(p_2))
                long double x87_r7_3 = fconvert.t(arg2[2])
