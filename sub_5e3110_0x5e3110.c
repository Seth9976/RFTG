...
int32_tsub_5e3110(void* arg1, int32_t arg2)
{
    ...
    if (edx u>= ecx)
        do
            ...
            *(edx + 0xa) = edi_1
            ...
            if (esi * 2 s>= eax_7)
                uint32_t eax_8 = zx.d(ecx_1[-1])
                ecx_1 -= 0xc
                edi_1 = ((eax_8 + zx.d(edi_1)) s>> 1).w
                var_8 = ((zx.d(ecx_1[4]) + zx.d(var_8)) s>> 1).w
                var_c = ((zx.d(ecx_1[3]) + zx.d(var_c)) s>> 1).w
                var_10 = ((zx.d(ecx_1[2]) + zx.d(var_10)) s>> 1).w
                var_14 = ((zx.d(ecx_1[1]) + zx.d(var_14)) s>> 1).w
                var_18 = ((zx.d(*ecx_1) + zx.d(var_18)) s>> 1).w
                eax_7 = eax_1
                esi -= eax_7
        while (edx u>= ecx)
