...
int128_t*sub_563dc0(int32_t* arg1 @ esi)
{
    ...
    if (eax_1 u> ebx)
        sub_4c5870("mFreeListHead <= mMaxUsedCount", &data_83f3d3, "c:\ax2010\engine\DataArray.h", 
            0xce, "DataArray<struct Dx11BufferData>::DataArrayAlloc")
    ...
    if (eax_1 != ebx)
        ebx = eax_1
        arg1[3] = *(eax_1 * 0x24c + *arg1 + 0x248)
    else
        arg1[1] = ebx + 1
        arg1[3] = ebx + 1
    
    int128_t* result = ebx * 0x24c + *arg1
    sub_5abfc0(result, 0, 0x248)
    *(result + 0x248) = arg1[5] << 0x10 | ebx
    arg1[5] += 1
