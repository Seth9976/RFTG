...
float* __convention("regparm")sub_432a50(int32_t arg1, int32_t arg2, int32_t arg3, float* arg4, int32_t arg5)
{
    ...
    float* eax_3
    int32_t edx
    eax_3, edx = sub_431e10(&var_6c, arg5)
    float var_48[0x8]
    __builtin_memcpy(&var_48, eax_3, 0x20)
    void var_28
    __builtin_memcpy(&var_28, sub_431b80(eax_3, edx, arg3, arg2), 0x20)
    ...
    *arg4 = fconvert.s(fconvert.t(*arg4) * fconvert.t(0.0010000000474974513))
