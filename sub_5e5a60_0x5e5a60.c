...
int32_tsub_5e5a60(int32_t arg1, int32_t arg2)
{
        ...
        do
            ...
            if (eax_17 * 2 s>= eax - 0x100)
                ...
                *(ecx_1 + 0xa) = rol.w(var_1c, 8)
                ...
                var_20 = ((sx.d(rol.w(*edx_1, 8)) + sx.d(var_20)) s>> 1).w
                var_c = ((sx.d(rol.w(*(edx_1 + 2), 8)) + sx.d(var_c)) s>> 1).w
                var_10 = ((sx.d(rol.w(*(edx_1 + 4), 8)) + sx.d(var_10)) s>> 1).w
                var_14 = ((sx.d(rol.w(*(edx_1 + 6), 8)) + sx.d(var_14)) s>> 1).w
                var_18 = ((sx.d(rol.w(*(edx_1 + 8), 8)) + sx.d(var_18)) s>> 1).w
                var_1c = ((sx.d(rol.w(*(edx_1 + 0xa), 8)) + sx.d(var_1c)) s>> 1).w
                var_8 -= eax - 0x100
        while (ecx_1 - 4 u< i)
