...
int32_t*sub_6182f0(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i_1 != 0)
            ...
            do
                ...
                if (ecx_1 == 0x10)
                    var_8_1 = (0xff - esi_2) * var_8_1 u/ 0xff + var_c_1
                    edi_1 = (0xff - esi_2) * edi_1 u/ 0xff + ebx_1
                    ecx_7 = (0xff - esi_2) * ecx_7 u/ 0xff + var_10_1
                else if (ecx_1 == 0x20)
                    edi_1 += ebx_1
                    ...
                    ecx_7 = ecx_7 * var_10_1 u/ 0xff
                
                var_18_1 = &var_18_1[1]
                *var_1c_1 = (ecx_7 << 8 | var_8_1) << 8 | edi_1
                var_1c_1 = &var_1c_1[1]
            while (i != 0)
