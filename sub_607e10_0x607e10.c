...
voidsub_607e10(void* arg1, int32_t arg2, int32_t arg3)
{
    ...
    int32_t ecx_7 = *(esi + 0x130)
    
    if (ecx_7 != 0)
        sub_6365b0(eax, &__saved_edi, arg3, ecx_7, *(esi + 0x12c), *(esi + 0x12d), *(esi + 0x12e), 
            edx_2)
        return 
    
    sub_6367f0(eax, &__saved_edi, arg3, 
        sub_5d7e30(*(eax + 4), *(esi + 0x12c), *(esi + 0x12d), *(esi + 0x12e), edx_2))
}
