            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_18_1 != 0)
                ...
                while (true)
                    ...
                    uint32_t var_10_1 = zx.d((eax_18 u>> 0x10).b)
                    uint32_t esi_3 = zx.d(eax_18.b)
                    ...
                    uint32_t ebx_3 = zx.d((eax_20 u>> 8).b)
                    uint32_t var_8_1 = zx.d(eax_20.b)
                    ...
                    if (edx_5 == 0x10)
                        ecx_10 = (0xff - edi_5) * ecx_10 u/ 0xff + var_20_1
                        ebx_3 = (0xff - edi_5) * ebx_3 u/ 0xff + var_c_1
                        var_8_1 = (0xff - edi_5) * var_8_1 u/ 0xff + var_10_1
                        edx_5 = var_24_1
                    else if (edx_5 == 0x20)
                        ecx_10 += esi_3
                        ...
                        uint32_t eax_29 = var_8_1 + var_10_1
                        var_8_1 = eax_29
                        
                        if (eax_29 u> 0xff)
                            var_8_1 = 0xff
                    else if (edx_5 == 0x40)
                        ecx_10 = ecx_10 * esi_3 u/ 0xff
                        ebx_3 = ebx_3 * var_c_1 u/ 0xff
                        var_8_1 = var_8_1 * var_10_1 u/ 0xff
                        edx_5 = var_24_1
                    
                    result = result_2 + 4
                    *(result - 4) = (ecx_10 << 8 | ebx_3) << 8 | var_8_1
                    var_14_1 += result_1
                    ecx = arg1
                    result_2 = result
