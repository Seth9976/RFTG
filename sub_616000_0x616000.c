...
int32_t*sub_616000(int32_t* arg1)
{
    ...
    while (result[7] != 0)
        ...
        if (i != 0)
            do
                ...
                i -= 1
                uint32_t ecx_5 = zx.d((eax_3 u>> 0x10).b)
                uint32_t edi_1 = zx.d((eax_3 u>> 8).b)
                uint32_t esi_1 = zx.d(eax_3.b)
                
                if ((ecx & 1) != 0)
                    esi_1 = esi_1 * edx u/ 0xff
                    edi_1 = edi_1 * ecx_1 u/ 0xff
                    ecx_5 = ecx_5 * edx_1 u/ 0xff
                
                uint32_t* eax_7 = var_c_1
                var_8_1 = &var_8_1[1]
                *eax_7 = (ecx_5 << 8 | edi_1) << 8 | esi_1
                var_c_1 = &eax_7[1]
            while (i != 0)
