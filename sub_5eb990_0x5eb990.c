...
int32_tsub_5eb990(void* arg1, int32_t arg2)
{
    ...
    int32_t eax = ecx * 2
    void* ecx_1 = esi + ecx - 6
    uint32_t var_1c = zx.d(*(esi + ecx - 2))
    uint32_t var_20 = zx.d(*(ecx_1 + 3))
    uint32_t var_24 = zx.d(*(ecx_1 + 2))
    uint32_t var_28 = zx.d(*(ecx_1 + 1))
    void* eax_1 = esi + eax - 0xc
    uint32_t edi = zx.d(*(ecx_1 + 5))
    uint32_t var_2c = zx.d(*ecx_1)
    uint32_t var_18
    uint32_t var_14
    uint32_t var_10
    uint32_t var_c
