            ...
            *(esi + 0x1c) -= 1
            ...
            if (i_1 != 0)
                do
                    ...
                    uint32_t ebx_1 = zx.d((eax_20 u>> 8).b)
                    uint32_t ecx_9 = zx.d(eax_20.b)
                    
                    if ((eax & 1) != 0)
                        edi_1 = edi_1 * ecx u/ 0xff
                        ebx_1 = ebx_1 * edx u/ 0xff
                        ecx_9 = ecx_9 * eax_1 u/ 0xff
                        edx_4 = var_8_1
                    
                    edx_4 += result_1
                    *result_2 = (ecx_9 << 8 | ebx_1) << 8 | edi_1
                    result = result_2 + 4
                    var_8_1 = edx_4
                    result_2 = result
                while (i != 0)
