...
int80_tsub_433fc0(int32_t arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_695daa
    TEB* fsbase
    ...
    if ((data_316607c & 2) == 0)
        ...
        data_3166074 = sub_510710(data_307ca78, edx)
        int32_t var_8_4 = 0xffffffff
    
    int32_t eax_7 = sub_50eb00(data_3166078, 0)
    
    if ((data_316607c & 4) == 0)
        data_316607c.d |= 4
        int32_t var_8_5 = 2
        data_3166070 = sub_4f5220(data_307c760, "tbl_OffenseCard")
    ...
    int32_t eax_12 = data_3166070
    float var_20_1 = var_18
    float var_50[0x9]
    int32_t eax_13
    int80_t result
    result, eax_13 =
        sub_50fd20(eax_12, eax_7, 0, &var_50, data_3166074, eax_12, &data_84074c, &var_24, nullptr, 0)
