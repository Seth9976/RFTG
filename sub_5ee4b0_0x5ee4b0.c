...
int32_tsub_5ee4b0(void* arg1, int32_t arg2)
{
    ...
    uint32_t var_8 = zx.d(edi[3])
    uint32_t var_c = zx.d(edi[2])
    uint32_t var_10 = zx.d(edi[1])
    int16_t* eax = esi + ebx - 0x20
    int32_t var_24 = ebx
    uint32_t var_14 = zx.d(*edi)
    void* var_1c
    uint32_t var_18
    
    if (eax u>= esi)
        while (true)
            uint32_t ecx_1 = zx.d(edi[3])
            uint32_t edx_5 = zx.d(edi[2])
            uint32_t esi_1 = zx.d(edi[1])
            var_18 = zx.d(*edi)
            var_1c = edi - 8
