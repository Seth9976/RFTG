...
void* __convention("regparm")sub_431a70(int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4)
{
    // 第一条实际指令: float var_c = fconvert.s(fconvert.t(0.112199739f))
    float var_c = fconvert.s(fconvert.t(0.112199739f))
    
    if (arg3 == 3)
        var_c = fconvert.s(fconvert.t(0.0785398185f))
    else if (arg3 == 2)
        var_c = fconvert.s(fconvert.t(0.0628318563f))
