...
long doublestart(double arg1[0x2] @ xmm0, double arg2)
{
    ...
    while (true)
        ...
        double xmm2_1[0x2] = data_8a5b00
        double xmm4_1[0x2] = data_8a5b10
        uint64_t xmm6_1[0x2] = data_8a5b20
        uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, data_8a5af0), data_8a5b60)
        eax_2 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
        double xmm4_3[0x2] = *(eax_2 + 0x8a6000)
        xmm7_1 = (*(eax_2 + 0x8a5bf0)).q
        ...
        double xmm0_11 = arg2
        double xmm1_10[0x2] = _mm_cmpeq_sd((data_8a5b70).q, xmm0_11, 0)
        int32_t edx_2
        ...
        label_68bc9d:
            var_c = xmm1_10
            sub_5b50b6(&arg2, &arg2, &var_c, edx_2)
        ...
        if ((ecx_1 & 0xfff) != 0)
            if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
                ...
                xmm1_10 = data_8a5af0
                uint64_t xmm2_6[0x2] = data_8a5b60
    ...
    double xmm2_2[0x2] = data_8a5bc0
    double xmm1_3[0x2] = _mm_mul_pd(data_8a5bb0, xmm0_5)
    double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
    double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_2)
    double xmm2_3[0x2] = data_8a5bd0
    double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_8a5b30)
    uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0x8a5b40))
    ...
    double xmm2_5[0x2] = _mm_mul_pd(data_8a5be0, xmm0_5)
