            ...
            *(ecx + 0x1c) -= 1
            ...
            if (var_1c_1 != 0)
                ...
                while (true)
                    ...
                    uint32_t var_8_1 = zx.d((eax_27 u>> 8).b)
                    ...
                    if (eax_18 == 0x10)
                        ...
                        ecx_6 = (0xff - edi_2) * ecx_6 u/ 0xff + var_10_1
                    else if (eax_18 == 0x20)
                        esi_3 += ebx_2
                        ...
                        uint32_t eax_40 = var_8_1 + var_c_1
                        var_8_1 = eax_40
